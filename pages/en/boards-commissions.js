...
const Kurul = () => (
    <MasterPage>
	    ...
	    <h1>Boards</h1>
	    	...
	    	<span className="madde-span">• Doç. Dr. Fatma Orgun (Vise Chair), Ege Üniversitesi</span>
	    ...
	    <h1>Commissions</h1>
	    	...
	    	<span className="madde-span">• Doç. Dr. Fatma Orgun (Secretary), Ege Üniversitesi</span>
