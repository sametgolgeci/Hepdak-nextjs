      ...
      <div className="genel komisyon-paydas">
        ...
        <div className="collapse" id="CIC">
          <table className="table table-striped">
            <tbody>
              <tr>
                <td><Link href="doc/en/commission_meetings/CIC/2024.pdf"><a>2024 Annual Report</a></Link></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="collapse" id="WDC">
          <table className="table table-striped">
            <tbody>
              <tr>
                <td><Link href="doc/en/commission_meetings/WDC/2024-02.pdf"><a>2024 Annual Report for the Period July-December</a></Link></td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="collapse" id="EC">
          <table className="table table-striped">
            <tbody>
              <tr>
                <td><Link href="doc/en/commission_meetings/EC/2024.pdf"><a>2024 Annual Report for the Period July-December</a></Link></td>
              </tr>
            </tbody>
          </table>
        </div>
