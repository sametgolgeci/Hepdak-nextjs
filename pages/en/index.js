            ...
            <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <div className="main-top-one-content-full"><img className="slider-full-img" src="img/banner/2026/en/ramazan.jpeg"/></div>
                </div>
                <div className="carousel-item">
                  <Link href="https://forms.gle/DgUCkbjGJDH9d4U87" target="_blank">
                    <div className="main-top-one-content-full"><img className="slider-full-img" src="../img/banner/2026/en/degerlendirici.jpeg"/></div>
                  </Link>
                </div>
                <div className="carousel-item">
    ...
    <div className="main-new">
      <div className="main-new-block col-md-4 col-sm-12">
        <div className="main-new-block-alt">
          ...
          <Link href="en/all-news#121225" legacyBehavior>
          <div className="main-block-subtitle">
            ...
            <div className="block-subtitle-text">HEMDEK Meeting</div>
          </div>
          </Link>

          <Link href="en/all-news#031225" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">Webinar: Social Determinants of Health and Nursing Education</div>
          </div>
          </Link>

          <Link href="en/all-news#28291125" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">SABDEK General Assembly Meeting</div>
          </div>
          </Link>

          <Link href="en/all-news#06071125" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">HEPDAK 13th Institutional Training Workshop</div>
          </div>
          </Link>
