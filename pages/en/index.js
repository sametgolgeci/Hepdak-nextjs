            ...
            <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <div className="main-top-one-content-full"><img className="slider-full-img" src="img/banner/en/2025-nurses-week.jpeg"/></div>
                </div>
                ...
                <div className="carousel-item">
                  <Link href="https://forms.gle/M4f3LvdCsbYjzNyC8" target="_blank">
                    <div className="main-top-one-content-full"><img className="slider-full-img" src="img/banner/en/2025-training-application.jpeg"/></div>
                  </Link>
                </div>
                <div className="carousel-item">
