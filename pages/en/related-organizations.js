...
const Kuruluslar = () => (
    <MasterPage>
      <Head>
	      <title>HEPDAK | Related Organizations</title>
	    </Head>
      <div className="genel"><h1>Related Organizations</h1></div>
            ...
            <div>
              <table className="table table-striped">
                <thead className="thead-dark">
                  <tr>
                    <th scope="col" colSpan="2">National Organizations</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                  ...
                  <tr>
                    <th scope="row"><a href="http://www.apanetw.org" target="_blank">APANE</a></th>
                    <td>Asian and Pasific Alliance for Nursing Education, Taiwan</td>
                  </tr>
                </tbody>
              </table>
            </div>
