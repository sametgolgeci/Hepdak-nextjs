...
const Belgeler = () => (
    <MasterPage>
      ...
      <div className="genel">
        ...
        <p className="madde-p"><Link href="../doc/paydas_gorusleri/paydas_gorus_2025.pdf" target="_blank">HEPDAK Stakeholder Opinions 2025 (in Turkish)</Link></p>
        <p className="madde-p"><Link href="../doc/paydas_gorusleri/paydas_gorus_2024.pdf" target="_blank">HEPDAK Stakeholder Opinions 2024 (in Turkish)</Link></p>
