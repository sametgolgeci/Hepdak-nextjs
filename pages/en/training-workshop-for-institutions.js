...
const Uye = () => (
    <MasterPage>
      ...
      <div className="row">
        ...
        <h6><span className="badge badge-custom">11</span> 02 December 2023</h6>
        <p>
          <ul className="nav calistay-nav">
            ...
            <li className="nav-item">
              <a className="nav-link calistay-button" href="../doc/kurumlar_egitim_11/katilimci-listesi.pdf">Participant List</a>
            </li>
            <li className="nav-item">
              <a className="nav-link calistay-button" data-toggle="collapse" href="#collapseOnBir" role="button" aria-expanded="false" aria-controls="collapseOnBir">Presentations</a>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <a className="nav-link calistay-button" href="../doc/kurumlar_egitim_11/degerlendirme.pdf">Evaluation</a>
            </li>
          </ul>
        </p>
