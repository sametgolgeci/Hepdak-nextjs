...
const Rapor = () => (
    <MasterPage>
	    ...
	    <div className="genel">
	    	...
	    	<p className="madde-p">HEPDAK Faaliyet Raporu 2023 için <Link href="doc/hepdak-faaliyet-raporu-2023.pdf"><a>tıklayınız</a></Link></p>
	    	<p className="madde-p">HEPDAK Faaliyet Raporu 2022 için <Link href="doc/hepdak-faaliyet-raporu-2022.pdf"><a>tıklayınız</a></Link></p>
	    	<p className="madde-p">HEPDAK Faaliyet Raporu 2021 için <Link href="doc/hepdak-faaliyet-raporu-2021.pdf"><a>tıklayınız</a></Link></p>
