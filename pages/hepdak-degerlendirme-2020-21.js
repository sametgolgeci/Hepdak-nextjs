...
const Degerlendirme = () => (
    <MasterPage>
      <Head>
	    ...
	    <div className="genel">
	    	<h3>Hepdak 2020-2021 Değerlendirme Planı</h3>
	    	<p><h6>Ara değerlendirme için başvuran programlar</h6>İlgili programların, mevcut akreditasyon süreçlerinin kesintiye uğramaması için uzaktan değerlendirme yapılması planlanmıştır. Takımların, bu programların özdeğerlendirme raporlarını incelemesinden sonra saha ziyaretleri uzaktan yapılacak ve gerekirse pandemi sonrası ileri bir tarihte kurum ziyareti planlanacaktır.</p>
	    	<p><h6>Yeniden genel değerlendirme için başvuran programlar</h6>İlgili programların, mevcut akreditasyon süreçlerinin devamını desteklemek üzere yeniden değerlendirme yapılacak olan programlara özdeğerlendirme raporlarının incelenmesinden sonra uzaktan ziyaret yapılacak ve pandemi koşullarına göre ileri bir tarihte kurum ziyareti planlanacaktır.</p>
