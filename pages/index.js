            ...
            <div id="carouselExampleControls" className="carousel slide" data-ride="carousel">
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <Link href="/doc/form/2026-ogrenci-egitimi.docx" target="_blank">
                    <div className="main-top-one-content-full"><img className="slider-full-img" src="img/banner/2026/ogrenci-degerlendirici-egitim.jpeg"/></div>
                  </Link>
                </div>
      ...
      <div className="main-new-block col-md-4 col-sm-12">
        <div className="main-new-block-alt">
          ...
          <div className="main-block-subtitle">
            ...
            <div className="block-subtitle-text">HEPDAK 2026 Yılı Öğrenci Değerlendirici Çalıştayı Gerçekleştirildi</div>
          </div>
          </Link>

          <Link href="/haberler/2026-02-17-haber" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı</div>
          </div>
          </Link>
          ...
          <div className="main-block-subtitle">
            ...
            <div className="block-subtitle-text">HEPDAK 13. Kurumlar için Eğitim Çalıştayı</div>
          </div>
          </Link>

          <Link href="/haberler/2025-10-17-haber" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
              <div className="date-day">17</div>
            ...
            <div className="block-subtitle-text">STAR Akreditasyon Ajansı Konferansı</div>
          </div>
          </Link>
          ...
          <Link href="/haberler/2025-10-04-haber" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">HEPDAK Öğrenci Değerlendirici Eğitimi</div>
          </div>
          </Link>

          <Link href="/haberler/2025-09-29-haber" legacyBehavior>
          <div className="main-block-subtitle">
            <div className="block-subtitle-date">
            ...
            <div className="block-subtitle-text">Ondokuz Mayıs Üniversitesi Akreditasyon Belgesi Takdim Töreni</div>
          </div>
          </Link>
      ...
      <div className="main-new-block col-md-4 col-sm-12">
        <div className="main-new-block-alt">
          ...
          <div className="main-block-subtitle">
            ...
            <div className="block-subtitle-text">HEPDAK 2026 Eğitim Takvimi</div>
          </div>
          </Link>
