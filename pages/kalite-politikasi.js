...
const Kalite = () => (
    <MasterPage>
	    ...
	    <div className="genel">
	    	...
	    	<p>Akreditasyonun ana değerleri; öğrenme, toplum, sorumluluk, bütünlük ve sürekli iyileşmedir. HEPDAK, bu ana değerler doğrultusunda tüm paydaşlarına katkı sağlayacak ve geliştirecek hizmetler sunar. Değerlerin geliştirilmesi ve izlenmesi için geribildirim mekanizmalarını kullanır. Verdiği tüm hizmetlerin önce kuruma sonra da topluma yarar sağlamasına, hizmetlerini bütüncül bakış açısıyla yürütmesine ve aldığı geribildirimlerle sürekli iyileşmeye odaklanır.</p>
	    	...
	    	<p>Akreditasyon sürecinin her aşamasında görev alanlar paydaşlara karşı sorumludurlar. Tüm üyeler alanlarında uzmandırlar ve çalışmalarını açık ve hesap verebilmeye hazır yüksek düzey etik ilkelere göre yürütürler. Bu nedenle, HEPDAK Etik Kuralları çerçevesinde çıkar çatışması yaratmaktan kaçınarak profesyonel bir davranış sergilerler. HEPDAK akreditasyon faaliyetleri başta olmak üzere tüm faaliyetlerine ilişkin bilgilendirme ve hesap verme sorumluluğu taşır.</p>
	    </div>
    </MasterPage>
)
