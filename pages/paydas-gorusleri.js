...
const Gorus = () => (
    <MasterPage>
	    ...
	    <div className="genel">
	    	...
	    	<p className="madde-p">HEPDAK Paydaş Görüşleri 2025 için <Link href="doc/paydas_gorusleri/paydas_gorus_2025.pdf" target="_blank">tıklayınız</Link></p>
	    	<p className="madde-p">HEPDAK Paydaş Görüşleri 2024 için <Link href="doc/paydas_gorusleri/paydas_gorus_2024.pdf" target="_blank">tıklayınız</Link></p>
