		...
		<div className="genel col-md-12 col-sm-12 komisyon-paydas">
			...
			<div className="collapse" id="HLPYT">
				<table className="table table-striped">
	          	...
	          	<td>
	          		<Link
                      href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/03_1.pdf"
                      target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantı Duyurusu</Link><br/>
	          		<Link
                      href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/03_2.pdf"
                      target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı</Link>
	          	</td>
	        	</tr>
	        	<tr>
		          ...
		          <td>
			          <Link
                        href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/02_1.pdf"
                        target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 1</Link><br/>
			          <Link
                        href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/02_2.pdf"
                        target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 2</Link>
		          </td>
		        </tr>
		        <tr>
		          ...
		          <td>
		          	<Link
                      href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/01_1.pdf"
                      target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantı Duyurusu</Link><br/>
		          	<Link
                      href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/01_2.pdf"
                      target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı</Link>
		          </td>
		        </tr>
					</tbody>
			...
			<div className="collapse" id="TBT">
				<table className="table table-striped">
		          ...
		          <td><Link
                    href="doc/paydas_toplantilari/takim_baskanlari_toplanti/06.pdf"
                    target="_blank">Takım Başkanları Toplantısı</Link></td>
		        </tr>
						<tr>
		          <td scope="row" width="110px">04 Ocak 2023</td>
		          <td><Link
                    href="doc/paydas_toplantilari/takim_baskanlari_toplanti/05.pdf"
                    target="_blank">Takım Başkanları Toplantısı</Link></td>
		        </tr>
		      	<tr>
		          <td scope="row" width="110px">04 Ocak 2022</td>
		          <td><Link
                    href="doc/paydas_toplantilari/takim_baskanlari_toplanti/04.pdf"
                    target="_blank">Takım Başkanları Toplantısı</Link></td>
		        </tr>
		      	<tr>
		        ...
		        <tr>
		          ...
		          <td><Link
                    href="doc/paydas_toplantilari/takim_baskanlari_toplanti/02.pdf"
                    target="_blank">Takım Başkanları Toplantısı</Link></td>
		        </tr>
		        <tr>
		          <td scope="row" width="110px">16 Ocak 2018</td>
		          <td><Link
                    href="doc/paydas_toplantilari/takim_baskanlari_toplanti/01.pdf"
                    target="_blank">Takım Başkanları Toplantısı</Link></td>
		        </tr>
					</tbody>
				</table>
