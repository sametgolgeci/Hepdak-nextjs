		...
		<div className="genel col-md-12 col-sm-12 komisyon-paydas">
			...
			<div className="collapse" id="HLPYT">
				<table className="table table-striped">
	          	...
	          	<td>
	          		...
	          		<Link href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/03_2.pdf"><a target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3.2 (19 Ekim 2023)</a></Link>
	          	</td>
	        	</tr>
	        	<tr>
		          <th scope="row" width="10px"></th>
		          <td>
		          	<Link href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/02_1.pdf"><a target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantı Duyurusu - 2.1 (16 Şubat 2022)</a></Link><br/>
			          <Link href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/02_2.pdf"><a target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 2.2 (13 Ekim 2022)</a></Link><br/>
			          <Link href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/02_3.pdf"><a target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 2.3 (13 Ekim 2022)</a></Link>
		          </td>
		        </tr>
		        <tr>
		          <th scope="row" width="10px"></th>
		          <td><Link href="doc/paydas_toplantilari/hemsirelik_lisans_programı_yoneticileri_toplanti/01.pdf"><a target="_blank">Hemşirelik Lisans Programı Yöneticileri Toplantısı - 1 (24 Şubat 2022)</a></Link></td>
		        </tr>
					</tbody>
				</table>
			</div>
			...
			<div className="collapse" id="BKYT">
		        ...
		        <tr>
		          <th scope="row" width="10px"></th>
		          <td>
		          	<Link href="doc/paydas_toplantilari/basvuran_kurum_yoneticileri_toplanti/02_1.pdf"><a target="_blank">2022-2023 Dönemi HEPDAK Akreditasyon için Başvuran Kurumlara Yönelik Bilgilendirme Toplantı Duyurusu (17 Şubat 2022)</a></Link><br/>
			          <Link href="doc/paydas_toplantilari/basvuran_kurum_yoneticileri_toplanti/02_2.pdf"><a target="_blank">2022-2023 Dönemi HEPDAK Akreditasyon için Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (01 Mart 2022)</a></Link><br/>
			          <Link href="doc/paydas_toplantilari/basvuran_kurum_yoneticileri_toplanti/02_3.ppt"><a target="_blank">2022-2023 Dönemi Akreditasyon için Başvuran Kurumlar Sunumu (01 Mart 2022)</a></Link>
		          </td>
		        </tr>
		        <tr>
		          <th scope="row" width="10px"></th>
			...
			<div className="collapse" id="AZEKYT">
		        ...
		        <tr>
		          <th scope="row" width="10px"></th>
		          <td>
		          	<Link href="doc/paydas_toplantilari/akreditasyon_ziyaret_edilen_kurum_yonetici_toplanti/02_1.pdf"><a target="_blank">2021-2022 Dönemi Akreditasyon İçin Ziyaret Yapılan Kurumlar ile Toplantı Duyurusu (17 Şubat 2022)</a></Link><br/>
		          	<Link href="doc/paydas_toplantilari/akreditasyon_ziyaret_edilen_kurum_yonetici_toplanti/02_2.pdf"><a target="_blank">2021-2022 Dönemi Akreditasyon İçin Ziyaret Yapılan Kurumlar ile Toplantısı (15 Mart 2022)</a></Link>
		          </td>
		        </tr>
		        <tr>
		          <th scope="row" width="10px"></th>
		          <td><Link href="doc/paydas_toplantilari/akreditasyon_ziyaret_edilen_kurum_yonetici_toplanti/01.pdf"><a target="_blank">2020-2021 Dönemi Ziyaret Yapılan Kurum Temsilcileri ile Toplantısı (08 Mart 2021)</a></Link></td>
		        </tr>
					</tbody>
				</table>
			</div>
			...
			<div className="collapse" id="DTT">
				<table className="table table-striped">
					<tbody>
						<tr>
		          <th scope="row" width="10px"></th>
		          <td><Link href="doc/paydas_toplantilari/degerlendirme_takimlari_toplanti/05.pdf"><a target="_blank">HEPDAK Değerlendirme Takım Üyeleri Toplantısı - 4 (14 Haziran 2024)</a></Link></td>
		        </tr>
						<tr>
		          <th scope="row" width="10px"></th>
		          <td><Link href="doc/paydas_toplantilari/degerlendirme_takimlari_toplanti/04.pdf"><a target="_blank">HEPDAK Değerlendirme Takım Üyeleri Toplantısı - 3 (24 Ocak 2024)</a></Link></td>
		        </tr>
						<tr>
		          <th scope="row" width="10px"></th>
		        ...
		        <tr>
		          <th scope="row" width="10px"></th>
		          <td><Link href="doc/paydas_toplantilari/degerlendirme_takimlari_toplanti/02.pdf"><a target="_blank">HEPDAK Değerlendirme Takım Üyeleri Toplantısı - 1 (06 Ocak 2022)</a></Link></td>
		        </tr>
						<tr>
		          <th scope="row" width="10px"></th>
