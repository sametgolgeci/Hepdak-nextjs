...
const Rapor = () => (
    <MasterPage>
      ...
      <div className="genel">
        ...
        <p className="madde-p">HEPDAK Akredite Eğitim Programları İçin Gelişim Raporu Hazırlama Rehberi <strong>Sürüm 2.2</strong> (<Link href="doc/b13_v2_2.pdf"><a>PDF</a></Link> | <Link href="doc/b13_v2_2.docx"><a>Word</a></Link>)</p>
