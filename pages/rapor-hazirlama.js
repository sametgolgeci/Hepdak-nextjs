...
const Rapor = () => (
    <MasterPage>
      ...
      <div className="genel">
        ...
        <p className="madde-p">HEPDAK Öğrenci Değerlendirici Raporu <Link href="doc/b12_v6.pdf">Sürüm 6.0</Link></p>
        <p className="madde-p">HEPDAK Akredite Eğitim Programları İçin Gelişim Raporu Hazırlama Rehberi <strong>Sürüm 2.3</strong> (<Link href="doc/b13_v2_3.pdf">PDF</Link> | <Link href="doc/b13_v2_3.docx">Word</Link>)</p>
