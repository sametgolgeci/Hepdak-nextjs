          ...
          <div className="tab-content">
            <div id="yirmiuc" className="container tab-pane active">
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/01.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/01.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/02.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/02.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/03.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/03.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/04.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/04.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/05.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/05.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/06.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/06.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/07.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/07.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/2023-kurumlar-egitim-calistayi/08.png" target="_blank"><img className="calistay-img" src="/img/2023-kurumlar-egitim-calistayi/08.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
