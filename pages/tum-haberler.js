        ...
        <div>
          <ul className="nav justify-content-center">
            <li className="nav-item">
              <a className="nav-link main-second-nav-item active" data-toggle="pill" href="#yirmialti">2026</a>
            </li>
            <li className="nav-item">
              <a className="nav-link main-second-nav-item" data-toggle="pill" href="#yirmibes">2025</a>
            </li>
            <li className="nav-item">
          ...
          <div className="tab-content">
            <div id="yirmialti" className="container tab-pane active">
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">
                  ...
                  <p>Webinarda, hemşirelik eğitiminde insan bakım odaklı yaklaşımın önemi, bakım bilimi temelli eğitim anlayışının müfredatlara yansıtılması ve öğrencilerin bütüncül, etik ve insan merkezli bakım yeterlikleriyle yetiştirilmesi gerekliliği değerlendirilmiştir.</p>
                  <p>Toplantıya Türkiye’nin farklı üniversitelerinden 127 öğretim elemanı katılım sağlamıştır. Webinar, katılımcıların sorularının yanıtlanması ve iyi dileklerin paylaşılmasıyla sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/01.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/01.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/02.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/02.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/03.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/03.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/04.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/04.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/05.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/05.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/06.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/06.png" alt="Webinar 16"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="img/haberler/2026/webinar-16/07.png" target="_blank"><img className="calistay-img" src="img/haberler/2026/webinar-16/07.png" alt="Webinar 16"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2026 Yılı Değerlendirici Eğitimi Çalıştayı Gerçekleştirildi (25 Mart / 17-18 Nisan 2026)</div> 
                <div className="main-top-second-content">
                  <p>Hemşirelik Eğitim Programları Değerlendirme ve Akreditasyon Derneği (HEPDAK) tarafından düzenlenen 2026 Yılı Değerlendirici Eğitimi Çalıştayı, 25 Mart, 17 Nisan ve 18 Nisan 2026 tarihlerinde başarıyla gerçekleştirilmiştir. Program, açılış ve tanışma oturumu ile başlamış; ardından eğitim programının açıklanması ve lisans programı akreditasyon sürecine genel bakış oturumları ile devam etmiştir.</p>
                  <p>Çalıştay kapsamında katılımcılara HEPDAK akreditasyon süreci, Hemşirelik Lisans Eğitim Programı Standartları, sürekli iyileştirme ve PUKÖ döngüleri, program değerlendirici raporu hazırlığı ve değerlendirme sürecinde kullanılan belge ve formlar hakkında bilgi verilmiştir. Programın uygulama bölümünde ise öz değerlendirme raporunun ön incelemesi, program değerlendirici raporu üzerinden grup çalışmaları, grup sunumları ve standartlara yönelik değerlendirme oturumları gerçekleştirilmiştir. Ayrıca sürekli iyileştirme vaka analizi, görüşme teknikleri, iletişim ve çıkış bildirimi örneği sunumu ile değerlendirme sürecinin uygulamaya dönük önemli bileşenleri ele alınmıştır.</p>
                  <p>Bu çalıştay ile HEPDAK değerlendiricilerinin akreditasyon sürecinde güvenilir, tutarlı ve uygun değerlendirme kararları verebilmeleri; ziyaret öncesi, ziyaret sırası ve ziyaret sonrası süreçleri etik sorumluluk, etkili iletişim ve zaman yönetimi ilkeleri doğrultusunda yürütebilmeleri amaçlanmıştır. Program, genel değerlendirme ve kapanış oturumu ile tamamlanmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2026 Yılı Öğrenci Değerlendirici Çalıştayı Gerçekleştirildi (10 Nisan 2026)</div> 
                <div className="main-top-second-content">
                  <p>Hemşirelik Eğitim Programları Değerlendirme ve Akreditasyon Derneği (HEPDAK) tarafından düzenlenen 2026 Yılı Öğrenci Değerlendirici Çalıştayı, 10 Nisan 2026 tarihinde başarıyla gerçekleştirilmiştir. Program, ön test uygulaması ile başlamış; ardından açılış ve tanışma oturumu ile devam etmiştir.</p>
                  <p>Çalıştay kapsamında katılımcılara HEPDAK akreditasyon süreci, öğrenci değerlendiricilerin değerlendirme sürecindeki rolleri ve değerlendirme sürecinin davranışsal boyutu hakkında bilgi verilmiştir. Programın uygulama bölümünde ise soru hazırlama, rapor yazımı ve rapor sunumuna yönelik oturumlar gerçekleştirilmiş; katılımcılar süreç hakkında uygulamalı deneyim kazanma fırsatı bulmuştur. Ayrıca deneyim paylaşımı oturumunda, akreditasyon sürecinde öğrencinin rolü ele alınmış ve önceki deneyimlerden yola çıkılarak katılımcılara yol gösterici paylaşımlar sunulmuştur. Çalıştay, son test, genel değerlendirme ve kapanış oturumu ile tamamlanmıştır.</p>
                  <p>17 kurumdan 40 öğrencinin katılım sağladığı bu çalıştay ile öğrenci değerlendiricilerin akreditasyon süreçlerine ilişkin bilgi ve farkındalıklarının artırılması, değerlendirme sürecine etkin katılımlarının desteklenmesi amaçlanmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi (17 Şubat 2026)</div> 
                <div className="main-top-second-content">
                  <p>“Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu”, 17 Şubat 2026 tarihinde 12.30–16.30 saatleri arasında başarıyla gerçekleştirildi.</p>
                  <p>Farklı üniversitelerin hemşirelik bölümlerinde görev yapan 56 öğretim elemanının katılımıyla çevrim içi gerçekleştirilen kurs, hemşirelik eğitim programlarında kalite güvencesi ve sürekli iyileştirme kültürünün güçlendirilmesini amaçladı.</p>
                  <p>Prof. Dr. Gülseren Kocaman, Doç. Dr. Gülten Koç, Doç. Dr. Manar Aslan ve Doç. Dr. Demet İnangil’in eğitici olarak yer aldığı programda; sürekli iyileştirme (Sİ) yaklaşımı, PUKÖ döngüsünün hemşirelik eğitimine entegrasyonu ve akreditasyon sürecinde kanıt oluşturma yöntemleri kapsamlı biçimde ele alındı.</p>
                  <p>Kursun açılış oturumunda sürekli iyileştirme yaklaşımı ve başarım göstergelerinin özellikleri üzerinde duruldu. Devamında Sİ ve PUKÖ döngüsünün hemşirelik eğitimine uyarlanması, sürekli iyileştirme için beklenen kanıtların niteliği ve örnek PUKÖ uygulamaları katılımcılarla paylaşıldı. Vaka temelli grup çalışmaları ve tartışmalarla desteklenen programda katılımcılar; yapı–süreç–sonuç unsurlarına göre başarım göstergeleri oluşturma, PUKÖ temelli iyileştirme planı hazırlama ve uygulamaları akreditasyon kanıtına dönüştürme konularında uygulamalı deneyim kazandı. Grup sunumları ile deneyimler paylaşılırken, tartışmalarla öğrenme süreci pekiştirildi. Değerlendirme ve geri bildirimlerin alınmasının ardından kurs programı tamamlanmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/01.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/02.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/03.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/04.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/05.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/06.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/06.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/07.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/07.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/08.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/08.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/09.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/09.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2026/puko/10.png" target="_blank"><img className="calistay-img" src="/img/haberler/2026/puko/10.png" alt="Hemşirelik Eğitiminde Sürekli İyileştirme ve PUKÖ Döngüsünün Etkin Kullanımı Kursu Gerçekleştirildi"/></a></div>
                  </div>
                </div>  
              </div>
            </div>
            <div id="yirmibes" className="container tab-pane">
              <div className="main-top-second">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 13. Kurumlar için Eğitim Çalıştayı (06-07 Kasım 2025)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK Kurum Eğitimi Çalıştaylarının 13.sü 06-07 Kasım 2025 tarihlerinde iki tam gün olarak çevrimiçi gerçekleştirilmiştir. Ağırlıklı olarak grup çalışmalarıyla yürütülen eğitime 46 farklı kurumdan 89 öğretim elemanı katılmıştır. Eğitimin birinci günü sürekli iyileştirme, ikinci günü ise temel standartlara yönelik grup çalışmaları yapılmıştır. Toplantıda Prof. Dr. Ükke KARABACAK Acıbadem Üniversitesi Sağlık Bilimleri Fakültesi, Doç. Dr. Gülten OKUROĞLU ise Marmara Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümünün akreditasyon süreçlerine ilişkin deneyimlerini paylaşmıştır. Toplantı genel tartışma bölümüyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">Ondokuz Mayıs Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümü Akreditasyon Belgesi Takdim Töreni (29 Eylül 2025)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK akreditasyon değerlendirmeleri sonucunda 2025-2030 yıllarını kapsayan beş yıllık süre için akredite olan Ondokuz Mayıs Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümüne HEPDAK Yönetim Kurulu Üyesi Prof. Dr. Özen KULAKAÇ’ın katılımıyla belge takdim töreni düzenlenmiştir. Prof. Dr. Özen KULAKAÇ takdim töreninde kısaca eğitimde akreditasyon, hemşirelik eğitiminde akreditasyonun gereği ve önemi, eğitimde kalite süreçlerinde liderlik ve yönetim desteğinin öneminden söz etmiştir. HEPDAK ve HEPDAK değerlendirme standartlarına da kısaca değinen Prof. Dr. Özen KULAKAÇ, Ondokuz Mayıs Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümü "Akreditasyon Belgesi"ni Rektör Yardımcısı Prof. Dr. Çetin KURNAZ’a takdim etmiştir. Prof. Dr. Çetin Kurnaz konuşmasında, Hemşirelik Bölümünün üniversite ve fakülte içindeki kalite ve araştırma süreçlerine sunduğu katkıların altını çizmiştir. Hemşirelik Bölümü öğretim elemanları ve birinci sınıf öğrencilerinin de hazır bulunduğu törende akreditasyon sürecinde emeği geçen öğretim elemanlarına Sağlık Bilimleri Fakültesi Dekanı Esra PANCAR YÜKSEL, Hemşirelik Bölüm Başkan Doç. Dr. Esra TURAL BÜYÜK ve HEPDAK yönetim Kurulu Üyesi Prof. Dr. Özen KULAKAÇ tarafından teşekkür belgeleri takdim edilmiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">2. Uluslararası Hemşirelik Eğitiminin Geleceği Kongresi Gerçekleştirildi (17-19 Eylül 2025)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK, HEMED ve Başkent Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümü iş birliği ile düzenlenen, “Mükemmel Bakım için Mükemmel Eğitim” temalı 2. Uluslararası Hemşirelik Eğitiminin Geleceği Kongresi, 17-19 Eylül 2025 tarihleri arasında yüz yüze gerçekleştirilmiştir. Onursal başkanlıklarını Prof. Dr. Gülseren KOCAMAN ve Prof. DR. Hülya OKUMUŞ’un yaptığı ve Türkiye’de hemşirelik eğitimi ve hizmetlerinin gelişmesine öncülük eden değerli hocamız Prof. Dr. Gülten UYER anısına düzenlenenen kongrenin açılışı kongre eş başkanları Başkent Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölüm Başkanı Prof.Dr. Azize KARAHAN, HEPDAK Başkanı Prof. Dr. Dilek Özmen, HEMED Başkanı Doç. Dr. Havva Arslan Yürümezoğlu ve Başkent Üniversitesi Kurucu Rektörü Prof. Dr. Mehmet Haberal tarafından yapılmıştır. Toplam 200 katılımcının yer aldığı kongrede; 6 kurs, 1 konferans, 8 panel ve 13 bildiri oturumu düzenlenmiştir.</p>
                  <p>Kongrenin birinci gününde gerçekleştirilen konferans ve panellerde, eğitimde liderlik, yapay zeka ve dijital teknolojilerle hemşirelik eğitimi, yeterliğe dayalı eğitim Bakım Odaklı Hemşirelik Eğitimi konuları ele alınmıştır. İkinci gün oturumlarında ise, “Akreditasyon hemşirelik eğitiminde fark yaratıyor mu?”, “Sağlığın sosyal belirleyicileri ve hemşirelik eğitimi”, “Meslekler arası iş birliği ve iyi uygulama örnekleri” başlıklı paneller gerçekleştirilmiştir. Kongrenin son oturumu ise, akreditasyon süreciyle ilgili sık sorulan soruların yanıtlandığı açık oturum olmuştur. Kongre, bildiri ödüllerinin verilmesi ve genel değerlendirme ile sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">
                  ...
                  <p>İkinci aşamada 29 Nisan-29 Mayıs 2025 tarihleri arasında bireysel ve takım çalışmaları yapan katılımcılar 30-31 Mayıs 2025 tarihlerinde eğitime çevrim içi sınıflarda küçük grup tartışmaları ve büyük grup sunumları ile devam etmiştir. Ayrıca gruba Prof. Dr. Özen KULAKAÇ tarafından Sürekli İyileştirme ve Prof. DR. Kadriye BULDUKOĞLU tarafından Vaka ile Görüşme Teknikleri- iletişim Çıkış Bildirimi Örneği başlıklı sunumlar yapılmıştır. genel değerlendirmeyle eğitim sona ermiştir. Eğitime Türkiye’nin farklı hemşirelik programlarından 32 değerlendirici adayı katılmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK 19 Şubat 2025 tarihinde, 2024-2025 döneminde akreditasyon için ziyaret edilen program yöneticiliyle çevrimiçi bir toplantı gerçekleştirmiştir. Toplantıya 18 kurum yöneticisi veya temsilcisi katılmıştır. Toplantıda standartlara ve akreditasyon süreçlerine ilişkin görüş alışverişinde bulunulmuştur.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/01.png" alt="HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/02.png" alt="HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/03.png" alt="HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/04.png" alt="HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2025/akreditasyon-icin-ziyaret-edilen-kurumlar/05.png" alt="HEPDAK 2024-2025 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (19 Şubat 2025)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
            ...
            <div id="yirmidort" className="container tab-pane">
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">
                  <p>HEPDAK ve HEMED iş birliği ile 26 Aralık 2024 tarihinde XIV’cüsü düzenlenen Webinar’da “Hemşirelikte değer temelli eğitim nasıl olmalı? Mevcut Eğitim Programlarına ve HUÇEP’e eleştirel bir bakış” konusu ele alındı. Bezmialem Üniversitesinden Prof. Dr. Hülya KAYA’nın konuşmacı olarak katıldığı webinara Sağllık Bilimleri Üniversitesi Hamidiye Hemşirelik Fakültesinden Prof. Dr. Merdiye ŞENDİR moderatörlük yaptı. Webinara Türkiye’nin çeşitli üniversitelerinden 175 öğretim üyesi katıldı. Webinarda Katılımcıların soru ve katkılarına da yer verildi.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">Webinar: Yönetici Hemşireler Mezunlarımızın Yetkinliklerini Nasıl Değerlendiriyor? (18 Aralık 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK - HEMED işbirliğiyle 18 Aralık 2024 tarihinde gerçekleştirilen webinarların XIII’cüsünde “Yönetici Hemşirelerin Hemşirelik Lisans Programı Mezunlarının Yetkinliklerini Değerlendirmesi” konusu ele alındı. Webinarın moderatörlüğünü Doç. Dr. Havva Arslan Yürümezoğlu yapmıştır. Webinarın konuşmacıları; Hacettepe Erişkin Hastanesi Hemşirelik Hizmetleri Müdürü Dr. Hümeyra ZENGİN, Anadolu Sağlık Merkezi Hasta Bakım ve Hemşirelik Hizmetleri Direktörü Uzm Hem. Birsen CİVİL SUBAŞ, Ankara Bilkent Şehir Hastanesi Gastroenteroloji Kliniği Sorumlu Hemşiresi Dr. Gülfikar GULKAYA olmuştur. Toplantıya Türkiye'nin farklı üniversitelerinden 222 öğretim elemanı katılmıştır. Webinarda misafir konuşmacılar katılımcıların soruları ve katkılarına da yanıt vermiştir. Webinar katılımcıların iyi dilekleriyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
...
açıldığı oturumla son bulmuştur.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2024 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 4 (12 Ekim 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK'ın paydaş toplantıları
kapsamında düzenlediği 2024 yılı
Hemşirelik Lisans Programı
Yöneticileri Toplantısının dördüncüsü
12 Ekim 2024 tarihinde çevrimiçi
olarak gerçekleştirilmiştir. Lisans
programlarından 114
yönetici/öğretim elemanı katıldığı
toplantı. HEPDAK yönetim kurulu
başkanı Prof. Dr. Dilek ÖZMEN'in
HEPDAK faaliyetleri ile ilgili
bilgilendirme sunumuyla başlamış,
Erciyes Üniversitesi Sağlık Bilimleri
Fakültesi Hemşirelik Bölümü öğretim
üyesi Prof. Dr. Sultan TAŞÇI “Liderlik
ve Kalite Güvencesi Kültürü” konulu
sunumunuyla devam etmiştir.
Toplantı hemşirelik lisans programı
yöneticilerinin HEPDAK’tan
beklentilerinin konuşulmasının
katılımcı sorularının yanıtlanmasının
ardından iyi niyet dilekleriyle sona
ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
...
alındı. Moderatörlüğünü Prof. Dr. Ayla
KEÇECİ'nin yaptığı webinara Çankırı Karatekin
Üniversitesi Sağlık Bilimleri Fakültesi
Hemşirelik Bölümünden Ar. Gör. Dr. Gülsüm
ÇONOĞLU konuşmacı olarak katılmıştır.
Toplantıya Türkiye'nin farklı üniversitelerinden
215 öğretim elemanı katılmıştır. Webinarın son
bölümünde katılımcıların soruları ve katkılarına
yer verilmiştir. Webinar katılımcıların iyi
dilekleriyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 12. Kurumlar için Eğitim Çalıştayı (19-20 Eylül 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK Kurum Eğitimi Çalıştaylarının 12.si 19-20 Eylül 2024 tarihlerinde iki yarım
gün olarak çevrimiçi gerçekleştirilmiştir. Rubrik derecelendirme sistemine göre
hazırlanmış olan eğitime 51 farklı kurumdan 105 öğretim elemanı katılım göstermiştir.
Eğitimde, her bir temel standarda ilişkin olarak hazırlanan örnek vakalar üzerinden 12 ayrı
grupta grup çalışması yapılmıştır. Toplantıda Prof. Dr. Zeynep ÖZER Akdeniz
Üniversitesi Hemşirelik Fakültesi, Prof. Dr. Ükke Karabacak Acıbadem Üniversitesi
Sağlık Bilimleri Fakültesi Hemşirelik Bölümünün akreditasyon süreçlerine ilişkin
deneyimlerini paylaşmıştır. Toplantı genel tartışma bölümüyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
...
ile odak grup görüşmeleri gerçekleştirilmiştir.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2024 Yılı Öğrenci Değerlendirici Eğitimi tamamlandı (08 Haziran 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK 2024 yılı Öğrenci Değerlendirici Eğitimi çevrimiçi ortamda gerçekleştirilmiştir.
08 Haziran 2024’de yapılan yarım günlük eğitimde katılımcılara sunumlarla lisans
programı akreditasyon süreci, HEPDAK rubrik değerlendirme süreci ve HEPDAK ziyaret
süreci ve öğrenci değerlendiricilerin değerlendirme sürecine katılımı hakkında genel bilgi
verilmiş, değerlendirme sürecinde davranışsal boyutun önemi vurgulanmıştır. Ardından
sekiz ayrı grupta soru hazırlama, uygulamalı görüşme ve vakalar üzerinden öğrenci
değerlendirici rapor yazımı grup çalışmaları gerçekleştirilmiş ve büyük grupta
tartışılmıştır. Programda son olarak daha önce değerlendirici olarak görev almış iki öğrenci
değerlendirici ile deneyim paylaşımı oturumu gerçekleştirilmiştir. Eğitimin
değerlendirilmesiyle program sona ermiştir. Eğitime Türkiye’deki 21 farklı akredite
hemşirelik programından 13 tanesi tazeleme eğitimi olmak üzere 48 öğrenci katılmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">Tekirdağ Namık Kemal Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümü Akreditasyon Belgesi Takdim Töreni (24 Mayıs 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK Akreditasyon değerlendirmeleri sonucu 2023-2024 döneminde akredite olan
Tekirdağ Namık Kemal Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik Bölümüne
HEPDAK Yönetim Kurulu başkanı Prof. Dr. Dilek ÖZMEN’in katılımıyla belge takdim
töreni düzenlenmiştir. Prof. Dr. Dilek ÖZMEN takdim töreninde kısaca HEPDAK hakkında
bilgi vermiş, Tekirdağ Namık Kemal Üniversitesi Sağlık Bilimleri Fakültesi Hemşirelik
Bölümünün akreditasyon süreçlerine değinmiş, ardından "Akreditasyon Belgesi"ni Rektör
Yardımcısı Prof. Dr. Gülsüm ÖZKAN, Sağlık Bilimleri Fakültesi Dekan V. Prof. Dr. Tülin
YILDIZ, Hemşirelik Bölüm Başkan V. Dr. Öğr. Üyesi Arzu MALAK ve Hemşirelik Bölümü
öğretim elemanlarına takdim etmiştir. Ayrıca programda HEPDAK öğrenci değerlendiricisi
olmaya hak kazanan Öğrenci Cihan ŞEKER, Öğrenci Remziye AYDOĞDU, Öğrenci Aslı
Çağla AKAMCA ve Öğrenci Emre KOŞAR’a HEPDAK Yönetim Kurulu Başkanı Prof. Dr.
Dilek ÖZMEN ve Sağlık Bilimleri Fakültesi Dekan V. Prof. Dr. Tülin YILDIZ tarafından
başarı belgeleri takdim edilmiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
...
Sürecinde Yaşanan Sorunlar" çevrimiçi webinarı sonrası öğretim üyelerinden jürilerin
(mevcut durumda yapan ya da yapacak olan) katılacağı bir toplantı düzenlenmesi
konusunda gelen talepler üzerine 1 Nisan 2024 tarihinde yalnızca jürilere yönelik bir
toplantı düzenlenmiştir. Moderatörlüğünü Akdeniz Üniversitesi Hemşirelik
Fakültesinden Prof. Dr. Kadriye BULDUKOĞLU ve Sağlık Bilimleri Fakültesi,
Hemşirelik Bölümünden Prof. Dr. Ükke KARABACAK’ın yaptığı çevrimiçi
toplantıya çeşitli üniversitelerin hemşirelik programlarından 142 öğretim üyesi
katılmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/01.png" alt="Doçentlik Değerlendirme Sürecinde Yaşanan Sorunlar - Jüriler İle Toplantı (01 Nisan 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/02.png" alt="Doçentlik Değerlendirme Sürecinde Yaşanan Sorunlar - Jüriler İle Toplantı (01 Nisan 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-04-01-juriler-ile-toplanti/03.png" alt="Doçentlik Değerlendirme Sürecinde Yaşanan Sorunlar - Jüriler İle Toplantı (01 Nisan 2024)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">Webinar: Webinar Öğrenci Merkezli Eğitim Uygulamaları (06 Mart 2024)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK ve HEMED İşbirliğiyle düzenlenen webinarlardan X.sunda, Öğrenci
merkezli eğitim uygulamaları konuşuldu. Moderatörlüğünü Ege Üniversitesi
...
videosuna HEPDAK sayfasında yer alan eğitimler sekmesinden ulaşabilir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/01.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/02.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/03.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/04.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/05.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-03-06-webinar-10/06.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-03-06-webinar-10/06.png" alt="Webinar: Webinar Öğrenci merkezli eğitim uygulamaları (06 Mart 2024)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
“Akademisyenlerin eğitim-öğretim performansının değerlendirilmesi” konusunda
gerçekleştirildi. Niğde Ömer Halisdemir Üniversitesi İİBF öğretim üyesi Prof. Dr.
Selen DOĞAN’ın “360 Derece Performans Değerlendirme Yöntemi” ve Koç
Üniversitesi Hemşirelik Fakültesi öğretim üyesi Prof. Dr. Ayişe KARADAĞ’ın
“Çoklu değerlendirme için örnek bir uygulama” başlıklı konuşmalarını sunduğu
webinarın moderatörlüğünü Prof. Dr. Gülseren KOCAMAN yaptı. Toplantıya
Türkiye'nin farklı üniversitelerinden hemşirelik programları öğretim
elemanlarının yanı sıra ECZAKDER ve EPDAB’dan temsilciler de katıldı. 291
katılımcıyla gerçekleştirilen webinarın son bölümünde katılımcıların soru ve
katkılarına yer verildi. Toplantıya katılamayanlar ya da yeniden izlemek
isteyenler webinarın videosuna HEPDAK sayfasında yer alan eğitimler
sekmesinden ulaşabilir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/01.png" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/02.png" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/03.png" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/04.png" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/05.jpeg" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/05.jpeg" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/06.jpeg" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/06.jpeg" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/07.jpeg" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/07.jpeg" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/08.jpeg" target="_blank"><img className="calistay-img" src="/img/haberler/2024/2024-02-07-akademisyen-degerlendirme/08.jpeg" alt="Webinar: Akademisyenlerin Eğitim - Öğretim Performansının Değerlendirilmesi (07 Şubat 2024)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
süreçlerinde yaşanan sorunlar ve çözüm önerileri konuşuldu.</p>
            ...
            <div id="yirmiuc" className="container tab-pane">
              <div className="main-top-second">
...
eğitimler sekmesinden ulaşabilir.</p>
              ...
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/01.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/02.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/03.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/04.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/05.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/06.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/06.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/07.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/07.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-kurumlar-egitim-calistayi/08.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-kurumlar-egitim-calistayi/08.png" alt="EPDAK 10. Kurumlar için Eğitim Çalıştayı (02 Aralık 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">Deprem Felaketi sonrası Hemşirelik Eğitimi ve Kriz Dönemleri için Planlama Çıkarımları: Deneyim paylaşımları (01 Aralık 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK ve HEMED işbirliği ile düzenlenen webinarların altıncısı HEMED Yönetim
Kurulu Başkanı Doç. Dr. Havva ARSLAN YÜRÜMEZOĞLU’nun moderatörlüğünde 01
Aralık 2023 tarihinde çevrimiçi olarak gerçekleştirilmiştir. "Deprem Felaketi sonrası
Hemşirelik Eğitimi ve Kriz Dönemleri için Planlama Çıkarımları: Deneyim paylaşımları”
konulu webinarda; Doç. Dr. Mehtap SÖNMEZ (Kahramanmaraş Sütçü İmam Üniversitesi
Sağlık Bilimleri Fakültesi), Prof. Dr. Rukiye AYLAZ (Inönü Üniversitesi Hemşirelik
Fakültesi), Doç. Dr. Ceyda BAŞOĞUL (Adıyaman Üniversitesi Sağlık Bilimleri
Fakültesi), Doç. Dr. Leyla ZENGİN AYDIN (Dicle Üniversitesi Sağlık Bilimleri Fakültesi)
ve Prof. Dr. Gülendam KARADAĞ (Dokuz Eylül Üniversitesi Hemşirelik Fakültesi) i
deprem sonrası zorlu hemşirelik eğitimi deneyimlerini ve gelecek için çıkarımları tartıştılar.
Katılımcılar(164 katılımcı) webinara soru ve katkılarıyla yoğun katılım gösterdiler.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-6/01.jpeg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-6/01.jpeg" alt="Deprem Felaketi sonrası Hemşirelik Eğitimi ve Kriz Dönemleri için Planlama Çıkarımları: Deneyim paylaşımları (01 Aralık 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-6/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-6/02.png" alt="Deprem Felaketi sonrası Hemşirelik Eğitimi ve Kriz Dönemleri için Planlama Çıkarımları: Deneyim paylaşımları (01 Aralık 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2023 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3 (19 Ekim 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK'ın paydaş toplantıları kapsamında düzenlediği 2023 yılı Hemşirelik Lisans
Programı Yöneticileri Toplantısının üçüncüsü 19 Ekim 2023 tarihinde çevrimiçi olarak
gerçekleştirilmiştir. Toplantıya 70 kurumdan 76 yönetici/öğretim elemanı katılmıştır.
Toplantıda Prof. Dr. Dilek ÖZMEN'in akreditasyon çalışmaları ile ilgili sunumun yanı sıra
Standartları Belirleme ve Geliştirme Komisyonu üyesi Prof. Dr. Sergül DUYGULU
hemşirelik lisans eğitim programı standartlarının dereceli(rubrik) değerlendirmesi süreci
konusunda bir bilgilendirme sunumu yapmıştır. Toplantı katılımcı sorularının yanıtlanmasının
ardından iyi niyet dilekleriyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hemsirelik-lisans-program-toplantilari/01.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hemsirelik-lisans-program-toplantilari/01.jpeg" alt="HEPDAK 2023 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3 (19 Ekim 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hemsirelik-lisans-program-toplantilari/02.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-hemsirelik-lisans-program-toplantilari/02.png" alt="HEPDAK 2023 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3 (19 Ekim 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hemsirelik-lisans-program-toplantilari/03.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-hemsirelik-lisans-program-toplantilari/03.png" alt="HEPDAK 2023 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3 (19 Ekim 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hemsirelik-lisans-program-toplantilari/04.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-hemsirelik-lisans-program-toplantilari/04.png" alt="HEPDAK 2023 yılı Hemşirelik Lisans Programı Yöneticileri Toplantısı - 3 (19 Ekim 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">1.Uluslararası Hemşirelik Eğitiminin Geleceği Kongresi gerçekleştirildi (20-22 Eylül 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK ve HEMED iş birliği ile “Akreditasyonun Getirdiği Yenilikler ve Hemşirelik
Eğitiminin Dönüşümü” temalı <strong>“1.Uluslararası Hemşirelik Eğitiminin Geleceği Kongresi” </strong>20-22 Eylül 2023 tarihlerinde çevrim içi olarak gerçekleştirilmiştir. 177 katılımcının yer
aldığı kongrede 6 kurs, 2 konferans, 1 söyleşi oturumu, 6 panel ve 5 bildiri oturumu yer
almıştır. Kongre YÖKAK Temsilcisi Prof. Dr. Yunus Nadi Yüksek’in, üniversitenin temel
işlevinin nitelikli ve kaliteli eğitim olduğunu vurguladığı açılış konferansı ile başlamış, Prof.
Dr. İnci Erefe’nin “işini tutku ile yapmaya ve insani ve mesleki değerlere” vurgu yaptığı
söyleşisi ile devam etmiştir. Prof. Dr. Öktem Vardar akreditasyon sürecinde liderlik ve kalite
kültürü oluşturma isimli konferansında akreditasyona kurumsal ve mesleki bakış açılarının
farklılığını vurgulamış, eğitimin kalitesinden akademisyenlerin sorumlu olduğuna dikkat
çekmiştir. Kongrenin ilk günü öğleden sonra iki ayrı panelde ABD ve Kanada hemşirelik
akreditasyon derneklerinin yaklaşımları ve ülkemizde uluslararası akreditasyon almış olan
Koç Üniversitesinin deneyimleri konuşulmuş, ardından akredite olmuş dört kurumun eğitimde
kullandıkları süreçlerle ilgili iyi uygulama örneklerine yer verilmiştir.</p>
                  <p>Kongrenin ikinci gününe bakım bilimi temelli müfredat geliştirme konulu panel ile başlanmış
daha sonra 21. yüzyılda yükseköğrenim konulu panelde yapay zekanın getirdiği yenilikler ve
eleştirel düşünmenin eğitimdeki önemi konulu konferanslar yer almıştır. Ardından
gerçekleşen panelde Türkiye’de sağlık profesyonellerinin eğitimlerini akredite eden dört
kuruluşun(TEPDAD, ECZAKDER, SABAK, DEPAD) deneyimlerini ve iyi uygulama
örneklerini paylaşmıştır. Akredite kurumlara sorular interaktif oturumunda Ege üniversitesi,
Başkent Üniversitesi, Hacettepe Üniversitesi ve Sağlık Bilimleri Üniversitesi Hemşirelik
bölümleri akreditasyon deneyimlerini paylaşmış ve katılımcıların sorularına yanıt
vermişlerdir. Kongre oturumlarının sonuncusunda klinik rehberlik uygulamaları ile ilgili
Avustralya örneği sunulmuştur. Kongre bildiri ödüllerinin verilmesi ve kongrenin
değerlendirilmesiyle son bulmuştur.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/01.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/01.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/02.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/02.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/03.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/03.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/04.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/04.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/05.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/05.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/06.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/06.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/07.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/07.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/08.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/08.jpeg" alt="2023 HEGK"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-hegk/09.jpeg" target="_blank"><img className="calistay-img" src="img/haberler/2023-hegk/09.jpeg" alt="2023 HEGK"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
iyi dilekleriyle sona erdi.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">2023 - 2024 Dönemi Takım Başkanları Ön İnceleme Toplantısı (11 Temmuz 2023)</div> 
                <div className="main-top-second-content">
                  <p>2023 yılında akreditasyon sürecinde olup ara değerlendirme yapılacak olan kurumların
takım başkanları ile 11 Temmuz 2023 tarihinde çevrimiçi bir toplantı gerçekleştirilmiştir.
Toplantıda takım başkanlarına başvurular, süreçte yapılanlar, 2023-2024 dönemi
akreditasyon süreci ve çevrimiçi ziyaret süreci konullarında bilgi verilmiş, takım
başkanlarının ara ziyaret planı ve işleyişine yönelik görüş ve önerileri alınmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/01.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/01.png" alt="2023 - 2024 Dönemi Takım Başkanları Ön İnceleme Toplantısı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/02.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/02.png" alt="2023 - 2024 Dönemi Takım Başkanları Ön İnceleme Toplantısı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/03.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/03.png" alt="2023 - 2024 Dönemi Takım Başkanları Ön İnceleme Toplantısı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/04.png" target="_blank"><img className="calistay-img" src="img/haberler/2023-takim-baskanlari-on-inceleme-toplantisi/04.png" alt="2023 - 2024 Dönemi Takım Başkanları Ön İnceleme Toplantısı"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
kurumdan 13’üne HEPDAK Yönetim Kurulu ve Hemşirelik Eğitim Programları
Akreditasyon Kurulu (HEAK) Üyelerinin katılımıyla belge takdim töreni düzenlenmiştir.
Belge takdim törenleri, talep eden kurumların isteklerine göre yüz yüze ya da çevrimiçi
olarak Mayıs- Haziran 2023’te belirlenen tarihlerde gerçekleştirilmiştir. Bu kurumlardan
Erciyes Üniversitesi ve İnönü Üniversitesi hemşirelik bölümlerine çevrim içi, Erzincan
Binali Yıldırım Üniversitesi, Gaziantep SANKO Üniversitesi, Hacettepe Üniversitesi,
Hamidiye Üniversitesi, İzmir Katip Çelebi Üniversitesi, Karadeniz Teknik Üniversitesi,
Necmettin Erbakan Üniversitesi, Sağlık Bilimleri Üniversitesi Gülhane Hemşirelik
Fakültesi, Sivas Cumhuriyet Üniversitesi ve Yeditepe Üniversitesi Hemşirelik
Bölümlerine belgeleri yüz yüze takdim edilmiştir. Aynı dönemde akredite edilen, belge
takdim töreni talep etmeyen Manisa Celal Bayar Üniversitesi Sağlık Bilimleri Fakültesi ve
Medipol Üniversitesi Sağlık Bilimleri Yüksekokulu Hemşirelik Bölümlerine akreditasyon
belgeleri posta ile gönderilmiştir. Akredite olan kurumlarımızı kutluyor, kalite
yolculuklarında başarılar diliyoruz.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/01.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/01.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/02.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/02.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/03.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/03.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/04.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/04.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/05.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/05.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/06.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/06.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/07.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/07.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/08.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/08.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/09.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/09.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/10.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/10.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/11.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/11.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-belge-takdim/12.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-belge-takdim/12.jpg" alt="Akreditasyon Belgesi Takdim Töreni"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
yarım gün olarak 25-26 Mayıs 2023 tarihlerinde gerçekleştirilmiştir. Üç haftalık
sürecin ilk aşamasında yarım günlük giriş eğitimi yapılmış, çalışma grupları
oluşturulmuş, bireysel ve takım çalışmaları ile ilgili bilgilendirme yapılmıştır. İkinci
aşamada 3-24 Mayıs 2023 tarihleri arasında üç takım başkanının danışmanlığında
bireysel ve takım çalışmaları yürütülmüştür. Son aşama 25-26 Mayıs 2023
tarihlerinde Zoom sınıflarında küçük grup tartışmaları, ve büyük grup sunum
çalışmaları ile devam etmiş, sürekli iyileştirmeye yapılan vurgunun ardından
yapılan genel değerlendirmeyle sona erdirilmiştir. Eğitime 10 farklı programdan 12
değerlendirici adayı katılmıştır. Eğitimde daha önce eğitim almış iki değerlendirici de
tazeleme eğitimi amaçlı katılım göstermiştir.</p>
                </div>
                <div className="main-top-second-content"><a href="/img/haberler/2023-degerlendirici-egitimi/belge_01.pdf" target="_blank">- Değerlendirici Eğitimi Katılım Grupları</a></div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-degerlendirici-egitimi/01.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-degerlendirici-egitimi/01.jpg" alt="HEPDAK 2023 Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-degerlendirici-egitimi/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-degerlendirici-egitimi/02.png" alt="HEPDAK 2023 Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-degerlendirici-egitimi/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-degerlendirici-egitimi/03.png" alt="HEPDAK 2023 Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-degerlendirici-egitimi/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-degerlendirici-egitimi/04.png" alt="HEPDAK 2023 Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-degerlendirici-egitimi/05.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2023-degerlendirici-egitimi/05.jpg" alt="HEPDAK 2023 Değerlendirici Eğitimi"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK, Hemşirelik Programlarında Öğretme ve Öğrenme Destek Sistemleri:
Program Örnekleri webinarını gerçekleştirdi. Moderatörlüğünü Prof. Dr. Medine
YILMAZ'ın yaptığı webinara Erzincan Binali Yıldırım Üniversitesi Sağlık Bilimleri
Fakültesi Hemşirelik Bölümü öğretim üyesi Prof. Dr. Nadiye ÖZER, Hacettepe
Üniversitesi Hemşirelik Fakültesi öğretim üyesi Prof. Dr. Sergül DUYGULU, Koç
Üniversitesi Hemşirelik Fakültesi öğretim üyesi Fahriye OFLAZ konuşmacı olarak
katılmışlardır. Hemşirelik programlarında öğretme ve öğrenme destek
sistemleriyle ilgili iyi uygulama örneklerinin sunulduğu toplantıya Türkiye'nin farklı
üniversitelerinden 208 öğretim elemanı katılmıştır. Webinarın son bölümünde
katılımcıların soruları ve katkılarına yer verilmiştir. Webinar katılımcıların iyi
dilekleriyle sona ermiştir. Toplantıya katılamayanlar ya da yeniden izlemek
isteyenler webinarın videosuna HEPDAK sayfasında yer alan eğitimler
sekmesinden ulaşabilir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-program-ornekleri/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-program-ornekleri/01.png" alt="Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-program-ornekleri/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-program-ornekleri/02.png" alt="Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-program-ornekleri/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-program-ornekleri/03.png" alt="Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-program-ornekleri/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-program-ornekleri/04.png" alt="Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-webinar-program-ornekleri/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-webinar-program-ornekleri/05.png" alt="Webinar: Hemşirelik Programlarınta Öğretme ve Öğrenme Destek Sistemleri: Program Örnekleri (12 Nisan 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)</div> 
                <div className="main-top-second-content">
                  <p>2023-2024 dönemi akreditasyon için başvuran kurumlara yönelik bilgilendirme toplantısı 20 Mart
2023 tarihinde çevrimiçi olarak gerçekleştirilmiştir. Toplantıda HEPDAK değerleri, tematik analiz ve
HEPDAK beklentileri, HEPDAK değerlendirme süreci, özdeğerlendirme rehberi içeriğinin hazırlanması
ve HEMSİS kullanımı ile ilgili konulara yer verilmiş, katılanların soruları yanıtlanmıştır. Toplantıya
HEPDAK Yönetim Kurulu üyeleri ile birlikte 15 kurumdan 29 yönetici ve kalite sorumlusu katılmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/01.png" alt="2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/02.png" alt="2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/03.png" alt="2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/04.png" alt="2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-basvuru-bilgilendirme/05.png" alt="2023-2024 Dönemi Akreditasyon İçin Başvuran Kurumlara Yönelik Bilgilendirme Toplantısı (20 Mart 2023)"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2022-2023 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı (13 Mart 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK 13 Mart 2023 tarihinde, 2022-2023 döneminde akreditasyon için
ziyaret edilen kurumlarla çevrimiçi bir toplantı gerçekleştirmiştir. Toplantıya
14 kurumdan 25 kurum yöneticisi veya temsilcileri katılmıştır. Toplantıda
...
bulunulmuştur.</p>
                ...
                <div className="main-top-second-content">
                  <div className="row">
                    ...
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/02.png" alt="HEPDAK 2022-2023 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/03.png" alt="HEPDAK 2022-2023 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-akreditasyon-ziyaret-toplantisi/04.png" alt="HEPDAK 2022-2023 Dönemi Akreditasyon İçin Ziyaret Edilen Kurumlar ile Değerlendirme Toplantısı"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">Yükseköğretim Kalite Kurulu 2022 Yılı HEPDAK İzleme Ziyareti (22 Şubat 2023)</div> 
                <div className="main-top-second-content">
                  <p>YÖKAK Dış Değerlendirme ve Akreditasyon Kuruluşlarını İzleme çalışmaları kapsamında
2022 yılı faaliyetlerimizi izlemek üzere görevlendirilen YÖKAK izleme yetkilisi Sayın Prof.
Dr. Osman Uzun 22 Şubat 2023 Çarşamba günü derneğimize çevrimiçi izleme ziyaretini
gerçekleştirmiştir. İzleme ziyaretinin birinci oturumuna HEPDAK Yönetim Kurulu Başkanı
Prof. Dr. Dilek Özmen, Başkan Yardımcısı Doç. Dr. Fatma Orgun, Genel Sekreter, Prof. Dr.
Medine Yılmaz, Üye Prof. Dr. Özen Kulakaç; HEAK Başkanı Prof. Dr. Gülseren Kocaman ve
HEAK üyelerinden Prof. Dr. Ümit Seviğ, Prof. Dr. Hülya Okumuş, Hemşire Dr. Serap İleri;
HEPDAK Sekreteri Ümran Yalçın ve öğrenci değerlendirici Gizem Tunç katılmıştır. HEPDAK
Yönetim Kurulu Başkanı Prof. Dr. Dilek Özmen’in sunumunun ardından YÖKAK izleme yetkilisi
Sayın Prof. Dr. Osman Uzun dernek faaliyetlerine ilişkin bilgi almıştır.
İkinci oturumda ise; Standartları Belirleme ve Geliştirme Komisyonu Başkanı Prof. Dr.
Kadriye Buldukoğlu, Tutarlılık Kontrol Komitesinden Doç. Dr. Sergül Duygulu, İtiraz
Komisyonu Başkanı Prof. Dr. Hülya Okumuş, Eğitim Komisyonu Başkanı Prof. Dr. Medine
Yılmaz, Sürekli İyileştirme Komisyonu Başkanı Prof. Dr. Ayla Keçeci, Uluslararası İlişkiler
Komisyonu Başkanı Doç. Dr. Fatoş Korkmaz ve Yüksek Lisans Akreditasyonuna Hazırlık
Komisyonu Üyesi Prof. Dr. Ayla Bayık Temel katılmıştır. Komisyon üyelerinden
komisyonlarına yönelik iyileştirme çalışmaları hakkında bilgi alışverişinde bulunulduktan
sonra, toplantı karşılıklı iyi dilekler ile tamamlanmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-hepdak-izleme/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-hepdak-izleme/01.png" alt="Hepdak İzleme Ziyareti"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-hepdak-izleme/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-hepdak-izleme/02.png" alt="Hepdak İzleme Ziyareti"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-hepdak-izleme/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-hepdak-izleme/03.png" alt="Hepdak İzleme Ziyareti"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-hepdak-izleme/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-hepdak-izleme/04.png" alt="Hepdak İzleme Ziyareti"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-hepdak-izleme/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-hepdak-izleme/05.png" alt="Hepdak İzleme Ziyareti"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2023 yılı Öğrenci Değerlendirici Eğitimi tamamlandı (27-28 Ocak 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK 2023 yılı Öğrenci Değerlendirici Eğitimi çevrimiçi olarak
gerçekleştirilmiştir. Bu yıl yedincisi gerçekleştirilen eğitime 23 farklı kurumdan 43
öğrenci değerlendirici adayı katılmıştır. Öğrenciler eğitim öncesinde 5 gruba
ayrılmıştır. İlk olarak 27 Ocak 2023’te adaylara HEPDAK akreditasyon süreci,
öğrenci değerlendiricilerin değerlendirme sürecine katılımı, HEPDAK hemşirelik
lisans programı öğrenci değerlendirici standartları ve öğrenci değerlendirici rapor
yazımına ilişkin bilgi verilmiştir. Ardından daha önce değerlendiricilik yapan
öğrenciler deneyim paylaşımında bulunmuş, öğrenciler eğitim süresince yapılacak
bireysel ve takım çalışmalarına hazırlanmışlardır. İkinci olarak 28 Ocak 2023’te
5(beş) grupta yer alan öğrenciler, eğitici ve öğrenci mentorlarının başkanlığında,
eğitime katılan öğrencilerin aktif olduğu bir değerlendirme simülasyonu
deneyimlemiş ve bu deneyimlere ilişkin grup içi ve büyük gruplarda yansıtma
yapılmıştır. Ardından her bir grupta beş vaka üzerinden rapor yazımı çalışması
yapılmış, bu raporların büyük grupta sunumları ve değerlendirmeleri ile eğitim
sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/01.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/02.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/03.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/04.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/05.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/05.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/06.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/06.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/07.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/07.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-egitimi/08.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-egitimi/08.png" alt="Öğrenci Değerlendirici Eğitimi"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
değerlendirme sürecine ilişkin deneyimlerini, görüş ve önerilerini paylaşmışlardır.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2023 yılı Öğrenci Değerlendirici Adayları Toplantısı (12 Ocak 2023)</div> 
                <div className="main-top-second-content">
                  <p>HEPDAK Yönetim Kurulu, 12 Ocak 2023 tarihinde öğrenci değerlendirici
adaylarıyla çevrimiçi bir bilgilendirme toplantısı gerçekleştirmiştir. Toplantıya
çeşitli üniversitelerden 47 öğrenci katılmıştır. Toplantıda HEPDAK yönetim kurulu
başkan yardımcısı Prof. Dr. Medine YILMAZ tarafından öğrenci değerlendirici
olmanın anlamı ve değerlendirme sürecine ilişkin bilgilendirme yapılmıştır.
Ardından öğrencilerin öğrenci değerlendirici olma sürecine ilişkin soruları
yanıtlanmış ve toplantı iyi dileklerle sonlanmıştır.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/01.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/01.png" alt="Öğrenci Değerlendirici Adayları Toplantısı"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/02.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/02.png" alt="Öğrenci Değerlendirici Adayları Toplantısı"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/03.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/03.png" alt="Öğrenci Değerlendirici Adayları Toplantısı"/></a></div>
                    <div className="col-md-3 col-sm-12"><a href="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/04.png" target="_blank"><img className="calistay-img" src="/img/haberler/2023-ogrenci-degerlendirici-adaylari-toplantisi/04.png" alt="Öğrenci Değerlendirici Adayları Toplantısı"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
Moderatörlüğünü Doç. Dr. Fatma ORGUN'un yaptığı webinara Ege Üniversitesi Tıp
Fakültesi Tıp Eğitimi Anabilim Dalı Öğretim Üyesi Doç. Dr. Ayşe Hilal BATI “Program
Değerlendirme Süreci, Yaklaşım ve Modeller” ve Ege Üniversitesi Hemşirelik Fakültesi
Hemşirelikte Öğretim Anabilim Dalı Araş. Gör. Gülsüm ÇONOĞLU “Hemşirelik
Eğitiminde Program Değerlendirmeye Yönelik Bir Yol Haritası” başlıklı konuşmalarıyla
katılmışlardır. Toplantıya Türkiye'nin farklı üniversitelerinden 273 öğretim elemanı
katılmıştır. Webinarın son bölümünde katılımcıların soruları ve katkılarına yer verilmiştir.
Webinar katılımcıların iyi dilekleriyle sona ermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/webinar-10Kasim2022/01.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/webinar-10Kasim2022/01.jpg" alt="Webinar 10 Kasım 2022"/></a></div>
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/webinar-10Kasim2022/02.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/webinar-10Kasim2022/02.jpg" alt="Webinar 10 Kasım 2022"/></a></div>
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/webinar-10Kasim2022/03.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/webinar-10Kasim2022/03.jpg" alt="Webinar 10 Kasım 2022"/></a></div>
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/webinar-10Kasim2022/04.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/webinar-10Kasim2022/04.jpg" alt="Webinar 10 Kasım 2022"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK Türkiye Yeterlilikler Çerçevesi Uluslararası Konferansı’na katılım sağladı (26-27 Ekim 2022)</div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-12 col-sm-12"><a href="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/01.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/01.jpg" alt="2022 Yeterlilikler Çerçevesi Uluslararası Konferansı"/></a></div>
                  </div>
                </div>  
                <div className="main-top-second-content">
                  <p>Türkiye Yeterlilikler Çerçevesinin uygulanması ve işgücü piyasasına nitelikli işgücü
sağlanmasını amaçlayan TUYEP projesi kapsamında düzenlenen ve iki gün süren Türkiye
Yeterlilikler Çerçevesi Uluslararası Konferansı 26-27 Ekim 2022 tarihlerinde Çalışma ve
Sosyal Güvenlik Bakanı Prof. Dr. Vedat Bilgin’in katılımıyla İstanbul The Marmara Taksim
Hotel’de gerçekleştirildi.</p>
                  <p>Konferansın ilk gününde açılış konuşmaları Mesleki Yeterlilik Kurumu (MYK) Başkanı
Adem CEYLAN, AB Türkiye Delegasyonu Eğitim Sektör Yöneticisi Prof. Dr. Mustafa
BALCI, Yükseköğretim Kalite Kurulu Üyesi Prof. Dr. Vatan KARAKAYA ve MEB Mesleki
Teknik Eğitim Genel Müdürü Nazan ŞENER’ tarafından yapıldı.</p>
                  <p>Dünya Bankası’ndan Danışman Mikaela Kets, Avusturya UYÇ Ulusal Koordinasyon
Noktası’ndan Uzman Wolfgang Denk’in konuşmalarıyla devam eden ve TYÇ’ye yönelik
farkındalığın artırılması amacıyla, yeterliliklerin çerçevelere yerleştirilmesi, önceki
öğrenmelerin tanınması, kredi ve paydaşlar arası iletişim mekanizmaları gibi önemli bilgilerin
aktarıldığı Konferansta; “Avrupa Bağlamında TYÇ, Yeterlilikler Çerçevesi Konusunda
Avrupa’daki Gelişmeler” ile “Türkiye Yeterlilikler Çerçevesi; İşgücü piyasası ile Etkileşim”,
“Ulusal Yeterlilik Çerçevesinin Yaygınlaştırılması” gibi konular ele alındı. Toplantıda
HEPDAK Doç. Dr. Fatma ORGUN tarafından temsil edildi.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/02.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/02.jpg" alt="2022 Yeterlilikler Çerçevesi Uluslararası Konferansı"/></a></div>
                    <div className="col-md-6 col-sm-12"><a href="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/03.jpg" target="_blank"><img className="calistay-img" src="/img/haberler/2022-yeterlilikler-cercevesi-konferansi/03.jpg" alt="2022 Yeterlilikler Çerçevesi Uluslararası Konferansı"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
Yetiştirme Programlarını Değerlendirme ve Akreditasyon Derneği'nin(EPDAD) ev sahipliğinde
İstanbul’da düzenlenen CEENQA'nın yıllık Genel Kurulu ve çalıştayına katılmıştır.</p>
                  <p>23 Eylül 2022 tarihinde düzenlenen çalıştayda “Kalite güvence ajanslarının bağımsızlığı” konusu ele
        alınmış ve bu kapsamda ENQA başkanı, Avrupa Üniversiteler Birliği temsilcisi, akademi ve CEENQA
        topluluğu üyelerinin sunumlarına yer verilmiştir.</p>
                  <p>24 Eylül 2022’deki Genel Kurulda Franci Demšar (NAKVIS, Slovenya), CEENQA başkanlığına ikinci kez
        yeniden seçilmiş, Dinçay Köksal (EPDAD, Türkiye), Péter Levente Lakatos (MAB, Macaristan) ve Vesna
        Dodiković -Jurković (ASHE, Hırvatistan) yönetim kuruluna yeni seçilen üyeler olmuşlardır. Bu yılki
        genel kurulda Türkiye Ulusal Eczacılık Eğitimi Değerlendirme ve Akreditasyon Derneği (ECZAKDER),
        CEENQA'nın en yeni üyesi olarak toplantıya katılmıştır. Genel kurulda ayrıca ARSA (Rusya) ve NCPA
        (Rusya)’nın CEENQA'ya üyelikleri sonlandırılma kararı alınmıştır.</p>
                </div>
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">INQAAHE 2022 Yılı Genel Kurul Toplantısı (25 Mayıs 2022)</div>
                <div className="main-top-second-content">
...
yönetim kurulunun tanıtımı ve üyelik ile ilgili stratejilerin görüşülmesi gerçekleştirilmiştir.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">INQAAHE 2022 Yılı Webinarı - 2 (24 Mayıs 2022)</div>
                <div className="main-top-second-content">
...
öğretim, öğrenim ve kalite güvenliği uygulamaları konularına odaklanılmıştır.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">NAQA “Higher Education Quality Assurance in Wartime” Toplantısı (Savaş
Zamanında Eğitimde Kaliteyi Sürdürmek) (24 Mayıs 2022)</div>
                <div className="main-top-second-content">
...
üniversitelerinde temsil ofisleri sayesinde eğitimlerini sürdürmeye çalıştıklarını belirtmiştir.</p>
              ...
              <div className="main-top-second" id="ceenqa">
                <div className="main-top-second-title">CEENQA Paylaşım Toplantısı - 10 (18 Mayıs 2022)</div>
                <div className="main-top-second-content">
...
paydaş gruba eğitimler verildiğini bildirmiştir.</p>
              ...
              <div className="main-top-second">
                <div className="main-top-second-title">HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı (25 Haziran 2022)</div>
                <div className="main-top-second-content">
                  <p>HEPDAK 2022 yılı Değerlendirici Eğitimi  üç aşamalı olarak çevrimiçi ortamda 1 Haziran, 23-24 Haziran 2022 tarihlerinde gerçekleştirilmiştir. Üç haftalık sürecin ilk aşamasında yarım günlük giriş eğitimi yapılmış, bireysel ve takım çalışmaları ile ilgili bilgilendirme yapılmıştır. İkinci aşamada sekiz takım başkanının danışmanlığında bireysel çalışmalar ve takım çalışmaları yürütülmüştür. Son aşama 23-24 Haziran 2022 tarihlerinde Zoom sınıflarında küçük ve büyük grup tartışmaları, ikili karşılaştırma etkinlikleri ve büyük grup sunum çalışmaları ile sona erdirilmiştir. Eğitime 29 farklı programdan 40 değerlendirici adayı katılmıştır. Eğitimde daha önce eğitim almış dokuz değerlendirici de tazeleme eğitimi amaçlı katılım göstermiştir.</p>
                </div>
                <div className="main-top-second-content">
                  <div className="row">
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/08.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/08.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/09.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/09.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/10.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/10.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/11.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/11.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/12.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/12.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/13.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/13.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/14.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/14.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/15.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/15.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/16.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/16.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/17.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/17.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/18.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/18.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                    <div className="col-md-4 col-sm-12"><a href="/img/haberler/hepdak-degerlendirici-egitimi-2022/19.PNG" target="_blank"><img className="calistay-img" src="/img/haberler/hepdak-degerlendirici-egitimi-2022/19.PNG" alt="HEPDAK 2022 yılı Değerlendirici Eğitimi tamamlandı"/></a></div>
                  </div>
                </div>  
              </div>
              <div className="main-top-second">
...
projenin planlamalarını açıkladı. <a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">CEENQA Bi-Monthly Meetings</a></p>
            ...
            <div id="yirmi" className="container tab-pane fade">
              ...
              <div className="main-top-second">
                ...
                <div className="main-top-second-content">HEPDAK Uzaktan Eğitim Standartları hazırlandı. İlgili dosyaya <Link href="/doc/b14_v1.docx"><strong>buradan</strong></Link> ulaşabilirsiniz.</div>
              </div>
              <div className="main-top-second">
            ...
            <div id="ondokuz" className="container tab-pane fade">     
              <div className="main-top-second">
                <div className="main-top-second-title">Kurumlara Yönelik Eğitim Çalıştayı</div>
                <div className="main-top-second-content">Hemşirelik Lisans Eğitimi Veren Yükseköğretim Kurumlarına Yönelik Eğitim Çalıştayı 1 Aralık 2018 Cumartesi günü Anemon Ege Otel (İzmir)'de gerçekleştirilecektir. Çalıştay programına <Link href="doc/kurumlar-icin-egitim-calistayi-1aralik-2018-programi_v2.pdf"><strong>buradan</strong></Link> ulaşabilirsiniz.</div>
              </div>
              <div className="main-top-second">
                <div className="main-top-second-title">CEENQUA'da Sempozyum Haberimiz</div>
                <div className="main-top-second-content">CEENQUA'nın Temmuz haber bülteninde HEPDAK&HEMED birlikteliği ile gerçekleştirilen sempozyum haberimiz yer aldı. Habere <Link href="doc/8_1_july_2018.pdf"><strong>buradan</strong></Link> ulaşabilirsiniz.</div>
              </div>
              <div className="main-top-second">
