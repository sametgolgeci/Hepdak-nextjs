...
projenin planlamalarını açıkladı. <a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">CEENQA Bi-Monthly Meetings</a></p>
				...
				<div className="collapse" id="collapseCEENQA6">
					<p>Kalite güvencesi alanında CEENQA’ya üye ajansların kurumlarını, faaliyetlerini tanıttığı ve
yenilikçi çalışmaların periodik olarak paylaşıldığı altıncı topplantı 21 Temmuz 2021 tarihinde
çevrimiçi olarak gerçekleştirildi.HEPDAK’ı temsilen bu online toplantıya Prof. Dr. Ayla Bayık
Temel, Doç. Dr. Sergül Duygulu, Doç. Dr Fatoş Korkmaz ve Doç. Dr. Merlinda Aluş Tokat
katılmışlardır. Bu toplantıda Doç. Dr. Sergül Duygulu HEPDAK’IN misyonu, amaçları, değerleri,
yapısı program değerlendirme süreçleri, standartları ve geleceğe yönelik planlarını
açıklamıştır. Nataliia Stukalo Ukrayna ‘daYüksek Öğrenimde Kalite Güvenliği konulu
sunumunda; NAQA ajansının misyonu, amaçları, Ukrayna’da yüksek öğrenim, ajansın
üyelikleri, Covid 19 pandemi sürecinde faaliyetler ve ülkeler arası faaliyetleri hakkından
açıklamalar yapmıştır. Prof. Dr. Ayla Bayık Temel uzaktan değerlendirme ve uzaktan ziyaretler
açısından iyi uygulama örneği olarak HEPDAK’ın değerlendirmeciler için düzenlediği uzaktan
eğitim çalıştayı hakkında bilgiler vermiştir. İlgili sunumlara HEPDAK web sayfası yayınlar başlığı
altından ulaşabilirsiniz.</p>
				</div>
				...
				<div className="collapse" id="collapseCEENQA5">
					<p>CEENQA tarafından 2021 yılı etkinlikleri kapsamında iki ayda bir yürütülen 5. bilimsel toplantı
19 Mayıs 2021 tarihinde gerçekleştirilmiş olup, toplantıya HEPDAK’ı temsilen Prof.Dr. Ayla
Bayık Temel, Doç. Dr. Sergül Duygulu ve Doç. Dr. Fatoş Korkmaz katılmışlardır.</p>
				</div>
				...
				<div className="collapse" id="collapseCEENQA4">
					<p>CEENQA'NIN iki ayda bir yapılan üçüncü paylaşım toplantısı 17.03.2021 tarihinde
gerçekleştirilmiş. HEPDAK’ı temsilen Ayla Bayık Temel bu toplantıya katılmıştır. Georgia
(Gürcistan) da kalite ajansı olarak faaliyet gösteren NCEQE( National Center for Educational
Quality Enhancement) temsilcisi Khatia Tsiramua kurumun vizyon misyon ve yapısı
hakkında bilgi vermiş, stratejik hedeflerinden ve uluslararası projelerini, yükseköğrenimde
reform çalışmalarını açıklamıştır.</p>
				<p>Lithuania (Litvanya) da kalite ajansı olarak faaliyet gösteren SKVC temsilcisi Aurelija
Valeikienė, kurumun vizyon misyon ve yapısı hakkında bilgi vermiş, ,ulusal kalite güvenliği
sistemi ve ESG kriterlerinin karşılanması faaliyetlerini,tematik analiz sonuçlarını açıklamıştır.</p>
				<p>Gürcistan NCEQE ajansından Lali Giorgidze pandemi sonrasında yükseköğrenimde uzaktan
ve hibrid eğitiminde kalitenin desteklenmesi konulu sunumunu yürüttükleri projeden elde
ettikleri sonuçlar hakkında bilgi vererek paylaşmıştır.<a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">CEENQA Bi-Monthly Meetings</a></p>
				</div>
				...
				<div className="collapse" id="collapseCEENQA3">
					<p>19 Ocak 2021 tarihinde düzenlenen CEENQA’nın iki aylık toplantılarının üçüncüsüne
HEPDAK ‘ı temsilen Prof. Dr. Ayla Bayık Temel ve Prof. Dr. Medine Yılmaz katılmıştır. ASIIN-
Almanya temsilcisi Dr. Iring Wasser ve AIKA- Letonya temsilcisi Jolanta Silka faaliyetlerine
ilişkin sunum yapmışlardır. ASIIN Ajansından Arne Thielenhaus veri ve kayıt yönetim sistemi
ile ilgili kullandıkları kapsamlı çok dilli bilgisayar programı hakkında bilgi vermiştir.</p>
				</div>
				...
				<div className="collapse" id="collapseCEENQA2">
					<p>İki ayda bir düzenlenen CEENQA toplantılarının ikincisi 17 Kasım 2020 tarihinde çevrimiçi
olarka gerçekleştirilmiştir. HEPDAK’ı temsilen toplantıya Prof. Dr. Ayla Bayık Temel, Prof.
Dr. Hülya Okumuş ve Prof. Dr. Medine Yılmaz katılmışlardır. Toplantıda Çek Cumhuriyetinden
NAB adına Martina Vidlakova ve Sırbistan’dan AHERS ajansı adına Duska Radmonavic sunum
yapmışlardır.</p>
				</div>
				...
				<div className="collapse" id="collapseCEENQA1">
					<p>CEENQA genel kurulunda alınan karar doğrultusunda iki ayda bir düzenlenecek
olan paylaşım toplantılarının ilki 15 Ekim 2020 tarihinde düzenlenmiş olup
HEPDAK’ı temsilen Prof. Dr. Ayla Bayık Temel ve Prof. Dr. Hülya Okumuş
katılmışlardır. Toplantıda QAA (NAKVIS), Slovenya’dan başkan Franci Demšar ve
