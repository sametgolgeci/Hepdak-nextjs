	...
	<div className="row">
		...
		<div className="madde-p">
			...
			<div className="collapse" id="collapseCEENQA12">
				<p>CEENQA tarafından iki ayda bir yapılan 12. toplantı 16 Kasım 2022 tarihinde gerçekleşmiştir. HEPDAK’ı temsilen toplantıya Prof. Dr. Ayla BAYIK TEMEL ve Doç. Dr. Fatoş KORKMAZ katılmışlardır. Toplantının bu oturumunda CEENQA’ya üye Bulgaristan akreditasyon kuruluşu National Evaluation and Accreditation Agency (NEAA) temsilcisi kuruluşun yapısı, misyonu, amaçları, faaliyet alanları ve ulusal/uluslararası akreditasyon süreçlerini paylaşmıştır. Kosova kuruluşu Kosovo Accreditation Agency (KAA) temsilcisi FlamarAbazaj kuruluşun yapısı, ülkenin yükseköğrenim sistemi ve derneğin faaliyet alanlarını uzaktan eğitim sürecinde zorluklar ve uzaktan eğitimde digitalizasyon konularını katılımcılar ile paylaşmıştır.</p>
				<p>Oturumun son sunumunu Uluslararası İş Yönetimi Akreditasyonu Kuruluşunu (Foundation for International Business Administration FIBAA) temsilen Diane Freiberger, tematik konu olarak uzaktan eğitimde kalite güvenliği konusu ile ilgili sunum yapmıştır. Kurumun proje çalışması kapsamında beş temel standart hakkında bilgiler vermiştir.</p>
			</div>
			...
			<div className="collapse" id="collapseHepdakCEENQAGenelKurul">
				<p>HEPDAK’ı temsilen Doç. Dr. Fatoş Korkmaz, 23-24 Eylül 2022 tarihinde Türkiye'deki Öğretmen Yetiştirme Programlarını Değerlendirme ve Akreditasyon Derneği'nin(EPDAD) ev sahipliğinde İstanbul’da düzenlenen CEENQA'nın yıllık Genel Kurulu ve çalıştayına katılmıştır.</p>
				<p>23 Eylül 2022 tarihinde düzenlenen çalıştayda “Kalite güvence ajanslarının bağımsızlığı” konusu ele alınmış ve bu kapsamda ENQA başkanı, Avrupa Üniversiteler Birliği temsilcisi, akademi ve CEENQA topluluğu üyelerinin sunumlarına yer verilmiştir.</p>
				<p>24 Eylül 2022’deki Genel Kurulda Franci Demšar (NAKVIS, Slovenya), CEENQA başkanlığına ikinci kez yeniden seçilmiş, Dinçay Köksal (EPDAD, Türkiye), Péter Levente Lakatos (MAB, Macaristan) ve Vesna Dodiković -Jurković (ASHE, Hırvatistan) yönetim kuruluna yeni seçilen üyeler olmuşlardır. Bu yılki genel kurulda Türkiye Ulusal Eczacılık Eğitimi Değerlendirme ve Akreditasyon Derneği (ECZAKDER), CEENQA'nın en yeni üyesi olarak toplantıya katılmıştır. Genel kurulda ayrıca ARSA (Rusya) ve NCPA (Rusya)’nın CEENQA'ya üyelikleri sonlandırılma kararı alınmıştır.</p>
			</div>
			...
			<div className="collapse" id="collapseCEENQA11">
				<p>CEENQA'NIN iki ayda bir yapılan toplantısı 20 Temmuz 2022 tarihinde gerçekleştirilmiştir. Toplantıya HEPDAK’ı temsilen Prof. Dr. Ayla BAYIK TEMEL katılmıştır.</p>
				<p>Toplantıda CEENQA’ya üye Ermenistan akreditasyon kuruluşu ANQA’yı temsilen Varduhi Gyulazyan kuruluşun yapısı, misyonu, değerleri, faaliyet alanları ve akreditasyon süreçlerini, paydaş katılımlarını, öğrencilerin katılımı projesi konularında bilgiler vermiştir.</p>
				<p>Sırbistan kuruluşu NEAQA ‘yı temsilen Janko Balšić Sırbistanda yüksek öğrenim, kalite güvenliği, kuruluşun yapısı ve faaliyetlerini açıklamıştır.</p>
				<p>Nataliia Stukalo NAQA kuruluşunun Ukrayna’da süregiden savaş sürecinde kalite çalışmalarını ve üniversitelerde kalitenin sürdürülmesi için alınan önlemleri faaliyetleri açıklamıştır.</p>
			</div>
			...
			<div className="collapse" id="collapseCEENQA9">
				<p>CEENQA'NIN iki ayda bir yapılan 10.toplantısı 16 Mart 2022 tarihinde gerçekleştirilmiştir.Bu toplantıya HEPDAK’ı temsilen Prof. Dr. Ayla BAYIK TEMEL, Doç. Dr. Fatoş Korkmaz ve Doç. Dr. Merlinda Aluş katılmışlardır.</p>
				<p>Toplantının bu oturumunda CEENQA’ya üye Kazakistan akreditasyon kuruluşu Independent Agency For Accreditaiton and Rating (IAAR) temsilcisi Aikyz Bauyrzhankyzy kuruluşun yapısı, faaliyet alanları ve uluslararası akreditasyon süreçlerini paylaşmıştır.</p>
				<p>Estonya kuruluşu Estonian Quality Agency for Higher and Vocational Education (EKKA) temsilcisi Liia Lauri 2009 yılından beri faaliyet gösteren kuruluşun yapısı, ülkenin yükseköğrenim sistemi ve derneğin faaliyet alanlarını uzaktan eğitim sürecinde zorluklar ve uzaktan eğitimde kalite etiketi konularını katılımcılar ile paylaşmıştır.</p>
				<p>Oturumun son sunumunu Romanya kuruluşu olan The Romanıan Agency For Qualıty Assurance In Hıgher Educatıon (ARACIS) Octavian Mădălin Bunoıu temsilcisi gerçekleştirmiştir. Sunumda bu kapsamda ülkede akreditasyon süreçlerinin alt yapısını tamamlayan yasal düzenlemeler, yükseköğrenim sistemi ve ARACIS’in faaliyet alanları ile kuruluş yapısı sunulmuştur.</p>
			</div>
			...
			<div className="collapse" id="collapseCEENQA8">
				<p>CEENQA'NIN iki ayda bir yapılan sekizinci toplantısı 17 Kasım 2021 tarihinde gerçekleştirildi. Bu toplantıya HEPDAK’ı temsilen Prof. Dr. Ayla BAYIK TEMEL katıldı.</p>
				<p>Azerbeycan da faaliyet gösteren kalite ajansı TİKTA’yı temsilen Ilham Humbatov, kuruluşun yapısı, uluslararası üyelikleri, amaçları, kurum değerlendirmeleri konusunda bilgiler verdi.</p>
				<p>Montenegro (Karadağ) da faaliyet gösteren kalite ajansı AKOKVO,( Agency For Control And Quality Assurance Of Higher Education Montenegro ) temsilen Tijana Stanković “Quality Assurance of Higher Education in Montenegro -achievements and chalenges” konulu sunumunda ajansın yapısı, ülkede yükseköğrenim sistemi, paydaşlar, misyon, vizyon, istatistikler, kalite değerlendirme süreçleri ve yaşanan zorluklar konusunda açıklamalar yaptı.</p>
				<p>Milica Kavedžić AKOKVO da yürütülen BAQUAL (Better Academıc Qualıfıcatıons Through Qualıty Assurance) konulu yaşam boyu öğrenmenin kazandırılması ile ilgili ortak projenin planlamalarını açıkladı. <a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">CEENQA Bi-Monthly Meetings</a></p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA13ekim2021" role="button" aria-expanded="false" aria-controls="collapseCEENQA13ekim2021">- CEENQA'nın Yıllık Genel Kurulu ve Çalıştayı (13 Ekim 2021)</a>
			<div className="collapse" id="collapseCEENQA13ekim2021">
			...
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA7" role="button" aria-expanded="false" aria-controls="collapseCEENQA7">- CEENQA Paylaşım Toplantısı - 7 (15 Eylül 2021)</a>
			<div className="collapse" id="collapseCEENQA7">
				...
				<p>Colin Tück, Avrupa Yüksek Öğrenim İçin Kalite Güvenliği Ağı (European Quality Assurance Register for Higher Education) (EQAR DEQAR) temsilen Avrupa Yüksek Öğrenim Alanı ve Bologna Süreci (The European Higher Education Area -EHEA) kapsamında uluslararası şeffaflık ve otomatik tanınmanın desteklenmesi konusunda bilgiler vermiştir. Sunumlar ile ilgili ayrıntılı bilgilere <a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">https://www.ceenqa.org/ceenqa-bi-monthly-meetings/</a> linkinden ulaşabilir.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA6" role="button" aria-expanded="false" aria-controls="collapseCEENQA6">- CEENQA Paylaşım Toplantısı - 6 (21 Temmuz 2021)</a>
			<div className="collapse" id="collapseCEENQA6">
				<p>Kalite güvencesi alanında CEENQA’ya üye ajansların kurumlarını, faaliyetlerini tanıttığı ve yenilikçi çalışmaların periodik olarak paylaşıldığı altıncı topplantı 21 Temmuz 2021 tarihinde çevrimiçi olarak gerçekleştirildi.HEPDAK’ı temsilen bu online toplantıya Prof. Dr. Ayla Bayık Temel, Doç. Dr. Sergül Duygulu, Doç. Dr Fatoş Korkmaz ve Doç. Dr. Merlinda Aluş Tokat katılmışlardır. Bu toplantıda Doç. Dr. Sergül Duygulu HEPDAK’IN misyonu, amaçları, değerleri, yapısı program değerlendirme süreçleri, standartları ve geleceğe yönelik planlarını açıklamıştır. Nataliia Stukalo Ukrayna ‘daYüksek Öğrenimde Kalite Güvenliği konulu sunumunda; NAQA ajansının misyonu, amaçları, Ukrayna’da yüksek öğrenim, ajansın üyelikleri, Covid 19 pandemi sürecinde faaliyetler ve ülkeler arası faaliyetleri hakkından açıklamalar yapmıştır. Prof. Dr. Ayla Bayık Temel uzaktan değerlendirme ve uzaktan ziyaretler açısından iyi uygulama örneği olarak HEPDAK’ın değerlendirmeciler için düzenlediği uzaktan eğitim çalıştayı hakkında bilgiler vermiştir. İlgili sunumlara HEPDAK web sayfası yayınlar başlığı altından ulaşabilirsiniz.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA5" role="button" aria-expanded="false" aria-controls="collapseCEENQA5">- CEENQA Paylaşım Toplantısı - 5 (19 Mayıs 2021)</a>
			<div className="collapse" id="collapseCEENQA5">
				<p>CEENQA tarafından 2021 yılı etkinlikleri kapsamında iki ayda bir yürütülen 5. bilimsel toplantı 19 Mayıs 2021 tarihinde gerçekleştirilmiş olup, toplantıya HEPDAK’ı temsilen Prof.Dr. Ayla Bayık Temel, Doç. Dr. Sergül Duygulu ve Doç. Dr. Fatoş Korkmaz katılmışlardır.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA4" role="button" aria-expanded="false" aria-controls="collapseCEENQA4">- CEENQA Paylaşım Toplantısı - 4 (17 Mart 2021)</a>
			<div className="collapse" id="collapseCEENQA4">
				<p>CEENQA'NIN iki ayda bir yapılan üçüncü paylaşım toplantısı 17.03.2021 tarihinde gerçekleştirilmiş. HEPDAK’ı temsilen Ayla Bayık Temel bu toplantıya katılmıştır. Georgia (Gürcistan) da kalite ajansı olarak faaliyet gösteren NCEQE( National Center for Educational Quality Enhancement) temsilcisi Khatia Tsiramua kurumun vizyon misyon ve yapısı hakkında bilgi vermiş, stratejik hedeflerinden ve uluslararası projelerini, yükseköğrenimde reform çalışmalarını açıklamıştır.</p>
			<p>Lithuania (Litvanya) da kalite ajansı olarak faaliyet gösteren SKVC temsilcisi Aurelija Valeikienė, kurumun vizyon misyon ve yapısı hakkında bilgi vermiş, ,ulusal kalite güvenliği sistemi ve ESG kriterlerinin karşılanması faaliyetlerini,tematik analiz sonuçlarını açıklamıştır.</p>
			<p>Gürcistan NCEQE ajansından Lali Giorgidze pandemi sonrasında yükseköğrenimde uzaktan ve hibrid eğitiminde kalitenin desteklenmesi konulu sunumunu yürüttükleri projeden elde ettikleri sonuçlar hakkında bilgi vererek paylaşmıştır.<a href="https://www.ceenqa.org/ceenqa-bi-monthly-meetings/">CEENQA Bi-Monthly Meetings</a></p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA3" role="button" aria-expanded="false" aria-controls="collapseCEENQA3">- CEENQA Paylaşım Toplantısı - 3 (19 Ocak 2021)</a>
			<div className="collapse" id="collapseCEENQA3">
				<p>19 Ocak 2021 tarihinde düzenlenen CEENQA’nın iki aylık toplantılarının üçüncüsüne HEPDAK ‘ı temsilen Prof. Dr. Ayla Bayık Temel ve Prof. Dr. Medine Yılmaz katılmıştır. ASIIN- Almanya temsilcisi Dr. Iring Wasser ve AIKA- Letonya temsilcisi Jolanta Silka faaliyetlerine ilişkin sunum yapmışlardır. ASIIN Ajansından Arne Thielenhaus veri ve kayıt yönetim sistemi ile ilgili kullandıkları kapsamlı çok dilli bilgisayar programı hakkında bilgi vermiştir.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA2" role="button" aria-expanded="false" aria-controls="collapseCEENQA2">- CEENQA Paylaşım Toplantısı - 2 (17 Kasım 2020)</a>
			<div className="collapse" id="collapseCEENQA2">
				<p>İki ayda bir düzenlenen CEENQA toplantılarının ikincisi 17 Kasım 2020 tarihinde çevrimiçi olarka gerçekleştirilmiştir. HEPDAK’ı temsilen toplantıya Prof. Dr. Ayla Bayık Temel, Prof. Dr. Hülya Okumuş ve Prof. Dr. Medine Yılmaz katılmışlardır. Toplantıda Çek Cumhuriyetinden NAB adına Martina Vidlakova ve Sırbistan’dan AHERS ajansı adına Duska Radmonavic sunum yapmışlardır.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseCEENQA1" role="button" aria-expanded="false" aria-controls="collapseCEENQA1">- CEENQA Paylaşım Toplantısı - 1 (15 Ekim 2020)</a>
			<div className="collapse" id="collapseCEENQA1">
				<p>CEENQA genel kurulunda alınan karar doğrultusunda iki ayda bir düzenlenecek olan paylaşım toplantılarının ilki 15 Ekim 2020 tarihinde düzenlenmiş olup HEPDAK’ı temsilen Prof. Dr. Ayla Bayık Temel ve Prof. Dr. Hülya Okumuş katılmışlardır. Toplantıda QAA (NAKVIS), Slovenya’dan başkan Franci Demšar ve Kuzey Kıbrıs YÖDAK’ temsilen Akile Gürsoy sunumlar yapmışlardır.</p>
			</div>
		</div>
		...
		<div className="madde-p">
			...
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseExampleFoto" role="button" aria-expanded="false" aria-controls="collapseExampleFoto">- Fotoğraflar</a>
		...
		<div className="madde-p">
			<a href="/doc/hepdak_sunumlari/belge_1.pdf" className="uluslararasi-link" target="_blank">- Prof.Dr. Ayla Bayık Temel - CEENQUA 2020 Aralık 2020 Bülten Yazısı</a>
			<a href="/doc/hepdak_sunumlari/belge_3.pdf" className="uluslararasi-link" target="_blank">- Prof.Dr. Ayla Bayık Temel - CEENQUA 2020 Temmuz Bülten Yazısı</a>
		...
		<div className="madde-p">
			...
			<div className="collapse" id="collapseINQAAHE2024">
				<p>HEPDAK Uluslararası Komisyonu Çalışma Yönergesi doğrultusunda 2024 yılı ikinci yarısında çalışmalarını gerçekleştirmiştir. Komisyon HEPDAK’ın üyesi olduğu INQAAHE (The International Network for Quality Assurance Agencies in Higher Education) akreditasyon kuruluşunun gerçekleştirdiği toplantıları izlemiştir. Komisyon, INQAAHE’nın 22 Ekim tarihindeki toplantısına katılmıştır. Komisyon üyesi Sergül Duygulu Romanya ARACIS (Agency for Quality Assurance in Higher Education) tarafından uluslararası değerlendirici olarak kurumsal (06-08 Kasım 2024 / Grigore T. Popa University of Medicine and Pharmacy Iaşi - UMF "Grigore T. Popa" Iaşi) değerlendirmeye davet edilmiş ve kurum değerlendiricisi olarak faaliyet gerçekleşmiştir.</p>
			</div>
			...
			<div className="collapse" id="collapseINQAAHE310523">
				<p>HEPDAK uluslararası ilişkiler komisyonu üyeleri INQAAHE tarafından 31 Mayıs 2023 tarihinde Astana / Kazakistan da düzenlenen General Assembly Board of Elections’da online oylamaya çevrimiçi katılmışlardır.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseINQAAHE080523" role="button" aria-expanded="false" aria-controls="collapseINQAAHE080523">- INQAAHE Toplantısı - Talks on Building a Global Culture of Quality: the Role of Students in QA (08 Mayıs 2023)</a>
			<div className="collapse" id="collapseINQAAHE080523">
				<p>HEPDAK uluslararası ilişkiler komisyonu üyeleri, 8 Mayıs 2023 tarihinde “Talks on Building a Global Culture of Quality: the Role of Students in QA” konulu toplantıya çevrimiçi katılmıştır.</p>
			</div>
			...
			<div className="collapse" id="collapseINQAAHE240123">
				<p>HEPDAK uluslararası ilişkiler komisyonu üyeleri, 24 Ocak 2023 tarihinde INQAAHE tarafından düzenlenen “Talks session led by Tertiary Education global experts” konulu toplantıya çevrimiçi katılmıştır.</p>
			</div>
			...
			<div className="collapse" id="collapseINQAAHE070123">
				<p>HEPDAK Uluslararası İlişkiler Komisyonu (UİK), 7 Ocak 2023 tarihinde INQAAHE tarafından 2025 yılında düzenlenecek 25 Conference 2025 konferansı için ev sahipliği başvurusu yapmış ancak kongrenin ev sahipliğini yapmak üzere başvuru yapan kurumlar içinden JUAA- Japan University Accreditation Association seçilmiştir.</p>
			</div>
			...
			<div className="collapse" id="collapseINQAAHE210422">
				<p>HEPDAK’ın üye olduğu INQAAHE nin 2022 yılı 2. Bültenin de HEPDAK tarafından 21 Nisan 2022 tarihinde <strong>“Hemşirelik Programları Mezunlarını Neden İzlemelidir? Mezun Ve Öğretim Üyesi Görüşleri”</strong> konulu webinar programı hakkında açıklamalar yer almıştır.</p>
				<h6>Why Should Nursing Programs Track Graduates? The Faculty and Graduate Opinions webinar was held by HEPDAK on 21st of April 2022</h6>
				<p><strong>Association for Evaluation and Accreditation of Nursing Education Programs (HEPDAK)</strong></p>
				<p>Prof. Dr. Ayla Bayık Temel (moderator) opened the webinar by welcoming participants and briefly remarking that graduate nurses are potential advisors for the nursing schools in systematically reevaluating the program's success and quality assurance. Prof. Dr. Özden Kulakaç from Ondokuz Mayıs University reported that in ensuring quality assurance, university programs are directly responsible for considering the needs and expectations of their students, all other stakeholders, and the quality assurance of their outputs. Nursing programs should care about graduates' employment, job adaptation, continuous learning, appointment and promotion, academic advancement, or professional development. The aim of alumni follow-up is to contribute to the development of the training program, to get feedback on the changes in practice and the qualifications of colleagues.</p>
				<p>The challenge frequently faced in the follow-up of the graduates is the development and operation of a follow-up system. This challenge can be overcome to a great extent by developing loyal/committed graduates, supporting the graduate’s involvement, and using information systems for monitoring. Effective/continuous communication channels should be developed and kept open.</p>
				<p>Fatih Mehmet Çakıroğlu (MSN student) emphasized that to get the graduate nurses' continuous relationship with the faculty, students should gain an institutional identity during their training and be satisfied with their education. Graduates expect their programs to organize activities that bring them together with faculty members on specific dates and renew the curriculum and competencies to prepare graduates for the business environment.</p>
				<p>The webinar generated much interest; and the moderator fielded many questions and queries posed by participants to be answered by the presenters.</p>
			</div>
			...
			<div className="collapse" id="collapseINQAAHE240522">
				<p>Çıktıya dayalı eğitim ve kalite güvenliği konusunun incelendiği INQAAHE’nin Kolombiya Ulusal Akreditasyon Konseyi National Accreditation Council - Colombia (CNA) ve Red Iberoamericana para el Aseguramiento de la Calidad en la Educación Superior (RIACES). işbirliği ile düzenlediği 2022 yılı ikinci webinarı 24 Mayıs 2022 tarihinde gerçekleştirilmiştir. (Second Talks webinar on May 24 INQAAHE Talks series, Outcomes-Based Education and Quality Assurance). HEPDAK’ı temsilen bu toplantıya Prof. Dr. Ayla Bayık Temel ve Doç. Dr. Sergül Duygulu katılmışlardır. Toplantıda öğrencilerin öğrenme çıktılarına dayalı öğretim, öğrenim ve kalite güvenliği uygulamaları konularına odaklanılmıştır.</p>
			</div>
		</div>

		<h4>- Uluslararası Değerlendiricilik Faaliyetleri</h4>
		<div className="madde-p">
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseARACIS2024" role="button" aria-expanded="false" aria-controls="collapseARACIS2024">- Yüksek Öğrenimde Romanya Kalite Güvence Ajansı/ARACIS (06-08 Kasım 2024)</a>
			<div className="collapse" id="collapseARACIS2024">
				<p>Komisyon üyesi Sergül Duygulu Romanya ARACIS (Agency for Quality Assurance in Higher Education) tarafından uluslararası değerlendirici olarak kurumsal (06-08 Kasım 2024 / Grigore T. Popa University of Medicine and Pharmacy Iaşi - UMF "Grigore T. Popa" Iaşi) değerlendirmeye davet edilmiş ve kurum değerlendiricisi olarak faaliyet gerçekleşmiştir.</p>
			</div>
			...
			<div className="collapse" id="collapseIAAHEH071123">
				<p>HEPDAK değerlendiricilerimizden ve komisyon üyelerimizden Prof. Dr. Sergül Duygulu, ve Doç. Dr. İmatullah AKYAR bu dönem Indonesian Accreditation Agency for Higher Education in Health (IAAHEH) tarafından General Medical Council (GMC), United Kingdom işbirliği ile 07-11 Ağustos 2023 tarihleri arasında Jakarta’da düzenlenen “IAAHEH International Assessor Taining of Trainers" eğitimine katılmışlardır.</p>
			</div>
		</div>
		...
		<div className="madde-p">
			...
			<div className="collapse" id="collapseother2">
				<p>HEPDAK uluslararası ilişkiler komisyonu üyeleri UNESCO tarafından gerçekleştirilen “Explores ways to organize micro-credentials as a means for offering up-to-date, quality” toplantısına katılım göstermiştir.</p>
			</div>
			<a className="uluslararasi-link" data-toggle="collapse" href="#collapseother1" role="button" aria-expanded="false" aria-controls="collapseother1">- NAQA “Higher Education Quality Assurance in Wartime” Toplantısı (Savaş Zamanında Eğitimde Kaliteyi Sürdürmek) (24 Mayıs 2022)</a>
			<div className="collapse" id="collapseother1">
				<p>Dünya’yı ve özellikle Ukrayna’yı etkileyen savaş durumunun eğitim ve akreditasyona etkilerini gözden geçirmek için Ukrayna Yükseköğretim Akreditasyon Birliği (NAQA) önderliğinde 24 Mayıs 2022 tarihinde online düzenlenen toplantıya HEPDAK’ı temsilen Doç Merlinda Aluş katılmıştır.</p>
				<p>Toplantı ülkenin eğitim bakanın konuşması, ENQA başkanı (The European Association for Quality Assurance in Higher Education),EQAR başkanı (The European Quality Assurance Register for Higher Education),CEENQA başkanı (Central and Eastern European Network of Quality Assurance Agencies), OSCE proje koordinatörü gibi bir çok akreditasyon birliğinin katılımıyla yürütülmüştür. NAQA başkanı kurumların savaş öncesi ve sonrasında yürüttüğü aktiviteleri konusunda paylaşımlarda bulunmuştur. Kurumun savaş başlangıcından itibaren 762 kurumun öz değerlendirme raporu aldığını, 391 sonuç kararı verdiğini ve 604 kurumu savaş nedeniyle koşullu akredite ettiklerini vurgulamıştır. Toplantıda ülkenin önemli üniversitelerinin rektörleri bu süreçte eğitimlerini sürdürme şekillerini sunmuştur. Maripoul Üniversitesi, Karazin Üniversitesi, Dnipro Teknoloji Üniversitesi, Taras Shevchenko Üniversiteleri savaş sürecindeki eylem planlarını açıklamıştır. Üniversitelerin bir çoğu bu süreci kısmen on-line sürdürdüklerini, Erasmus gibi değişim programlarını değerlendirerek hem öğrenci hem öğretim elemanı değişimini gerçekleştirdiklerini ve özellikle Avrupa’daki üniversitelerinde temsil ofisleri sayesinde eğitimlerini sürdürmeye çalıştıklarını belirtmiştir.</p>
			</div>
		</div>
