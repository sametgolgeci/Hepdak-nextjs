...
const Uye = () => (
    <MasterPage>
	    <Head>
	      <title>HEPDAK | Üye Listesi</title>
	    </Head>
      <div className="genel">
	    <h1>Hemşirelik Eğitim Programları Değerlendirme ve Akreditasyon Derneği (HEPDAK) Üye Listesi</h1>
	    <table className="table table-striped">
                <tbody>
                  <tr>
                    <th scope="row" width="10px">1</th>
                    <td>Aklime Sarıkaya</td>
                  </tr>
                  <tr>
                    <th scope="row">2</th>
