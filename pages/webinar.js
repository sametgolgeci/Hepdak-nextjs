...
const Webinar = () => (
    <MasterPage>
	    ...
	    <div className="webinar-bottom-up">
	    	...
	    	<iframe width="480" height="360" src="https://www.youtube.com/embed/2t3_5Sbsgi8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	    </div>
	    <div className="webinar-bottom-up">
	    	<div className="webinar-bottom-up-title">- Covid-19 Sürecinde Hemşirelik Eğitimi (17 Haziran 2020) -</div>
	    	<iframe width="480" height="360" src="https://www.youtube.com/embed/BGs8vR3mzbE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	    </div>
    </MasterPage>
)
